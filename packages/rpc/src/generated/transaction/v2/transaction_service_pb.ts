 ...
 * account.
 *
 * Action Spec (Code Payment or Withdrawal):
 *
 * actions = [
...
export class MicroPaymentLimit extends Message<MicroPaymentLimit> {
   ...
   *
   * @generated from field: float per_transaction = 1;
   */
  perTransaction = 0;
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "per_transaction", kind: "scalar", T: 2 /* ScalarType.FLOAT */ },
  ]);
