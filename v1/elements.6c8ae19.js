...
const Zm = 34028234663852886e22, Gm = -34028234663852886e22, Qm = 4294967295, ed = 2147483647, td = -2147483648;
function za(n) {
  if (typeof n != "number")
    throw new Error("invalid int 32: " + typeof n);
  if (!Number.isInteger(n) || n > ed || n < td)
    throw new Error("invalid int 32: " + n);
}
function Yu(n) {
  if (typeof n != "number")
    throw new Error("invalid uint 32: " + typeof n);
  if (!Number.isInteger(n) || n > Qm || n < 0)
    throw new Error("invalid uint 32: " + n);
}
function cf(n) {
  if (typeof n != "number")
    throw new Error("invalid float 32: " + typeof n);
  if (Number.isFinite(n) && (n > Zm || n < Gm))
    throw new Error("invalid float 32: " + n);
}
const lf = Symbol("@bufbuild/protobuf/enum-type");
function nd(n) {
  const e = n[lf];
...
function il(n) {
  ...
  return o(-24, -18), o(-18, -12), o(-12, -6), o(-6), e ? pf(r, i) : xc(r, i);
}
function ad(n, e) {
  let t = xc(n, e);
  const r = t.hi & 2147483648;
  r && (t = pf(t.lo, t.hi));
  const i = hf(t.lo, t.hi);
  return r ? "-" + i : i;
}
function hf(n, e) {
  if ({ lo: n, hi: e } = ud(n, e), e <= 2097151)
...
class md {
  constructor(e, t) {
    this.varint64 = od, this.uint32 = cd, this.buf = e, this.len = e.length, this.pos = 0, this.view = new DataView(e.buffer, e.byteOffset, e.byteLength), this.textDecoder = t ?? new TextDecoder();
  }
  /**
...
const $s = Symbol("@bufbuild/protobuf/unknown-fields"), al = {
  readUnknownFields: !0,
  readerFactory: (n) => new md(n)
}, ul = {
  writeUnknownFields: !0,
  writerFactory: () => new fd()
};
function dd(n) {
    ...
    readMessage(n, e, t, r) {
      ...
      for (; e.pos < o; ) {
        ...
        switch (f.oneof && (m = m[f.oneof.localName], m.case != g && delete m.value, m.case = g, g = "value"), f.kind) {
          ...
          case "message":
            const b = f.T;
            h ? m[g].push(Ra(e, new b(), r)) : m[g] instanceof N ? Ra(e, m[g], r) : (m[g] = Ra(e, new b(), r), b.fieldWrapper && !f.oneof && !f.repeated && (m[g] = b.fieldWrapper.unwrapField(m[g])));
            break;
          case "map":
            let [O, A] = gd(f, e, r);
            m[g][O] = A;
...
function wd(n, e, t, r, i) {
  ...
  switch (yo(n, t.K, 1, o, !0), t.V.kind) {
    case "scalar":
      yo(n, t.V.T, 2, i, !0);
      break;
    case "enum":
...
function Td() {
  return Object.assign(Object.assign({}, pd()), { writeMessage(n, e, t) {
    const r = n.getType();
      ...
      switch (i.kind) {
        ...
        case "enum":
          ...
          if (c)
            ...
            o !== void 0 && yo(e, f, i.no, o, !!i.oneof || i.opt);
          break;
        case "message":
          if (c)
            for (const m of o)
...
let ln = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".split(""), gu = [];
for (let n = 0; n < ln.length; n++)
  gu[ln[n].charCodeAt(0)] = n;
gu["-".charCodeAt(0)] = ln.indexOf("+");
gu["_".charCodeAt(0)] = ln.indexOf("/");
const wf = {
  /**
...
`:
  ...
  enc(n) {
    ...
    for (let o = 0; o < n.length; o++)
      switch (r = n[o], t) {
        case 0:
          e += ln[r >> 2], i = (r & 3) << 4, t = 1;
          break;
        case 1:
          e += ln[i | r >> 4], i = (r & 15) << 2, t = 2;
          break;
        case 2:
          e += ln[i | r >> 6], e += ln[r & 63], t = 0;
          break;
      }
    return t && (e += ln[i], e += "=", t == 1 && (e += "=")), e;
  }
}, cl = {
      ...
      for (const [u, f] of Object.entries(r)) {
        ...
        if (m.repeated) {
          ...
          for (const b of f) {
            ...
            switch (m.kind) {
              case "message":
                ...
                break;
              case "enum":
                if (O = Du(m.T, b, i.ignoreUnknownFields), O === void 0)
                  continue;
                break;
              case "scalar":
                try {
          ...
          for (const [b, O] of Object.entries(f)) {
            ...
            switch (m.V.kind) {
              case "message":
                A = m.V.T.fromJson(O, i);
                break;
              case "enum":
                if (A = Du(m.V.T, O, i.ignoreUnknownFields), A === void 0)
                  continue;
                break;
              case "scalar":
                try {
            ...
            try {
              y[io(m.K, m.K == v.BOOL ? b == "true" ? !0 : b == "false" ? !1 : b : b).toString()] = A;
            } catch (M) {
          ...
          switch (m.kind) {
            ...
            case "scalar":
              try {
                ...
                throw O instanceof Error && O.message.length > 0 && (A += `: ${O.message}`), new Error(A);
              }
              break;
          }
      }
...
function Du(n, e, t) {
  ...
  throw new Error(`cannot decode enum ${n.typeName} from JSON: ${yf(e)}`);
}
function xd(n, e, t, r) {
  var i;
  if (e === void 0)
...
function fl(n, e, t) {
  if (e !== void 0)
    switch (n) {
      ...
      case v.BYTES:
        return tt(e instanceof Uint8Array), t || e.byteLength > 0 ? wf.enc(e) : void 0;
    }
}
function Bd() {
  return bd((n, e) => function(r, i, o) {
    if (r.kind == "map") {
      const c = {};
      switch (r.V.kind) {
        case "scalar":
        ...
        if (c[i] !== void 0)
          switch (r.kind) {
            case "oneof":
              ...
              let m = c[i].value;
              f && f.kind == "message" && !(m instanceof f.T) ? m = new f.T(m) : f && f.kind === "scalar" && f.T === v.BYTES && (m = so(m)), o[i] = { case: u, value: m };
              break;
            case "scalar":
            case "enum":
              let h = c[i];
              r.T === v.BYTES && (h = r.repeated ? h.map(so) : so(h)), o[i] = h;
              break;
            case "map":
              switch (r.V.kind) {
                case "scalar":
                case "enum":
                  if (r.V.T === v.BYTES)
                    for (const [b, O] of Object.entries(c[i]))
                      o[i][b] = so(O);
                  else
                ...
                case "message":
                  ...
                  for (const b of Object.keys(c[i])) {
                    let O = c[i][b];
                    y.fieldWrapper || (O = new y(O)), o[i][b] = O;
                  }
                  break;
              }
              break;
            case "message":
              ...
              if (r.repeated)
                ...
                const y = c[i];
                g.fieldWrapper ? /* We can't use BytesValue.typeName as that will create a circular import */ g.typeName === "google.protobuf.BytesValue" ? o[i] = so(y) : o[i] = y : o[i] = y instanceof g ? y : new g(y);
              }
              break;
          }
      }
      ...
      return e === t ? !0 : !e || !t ? !1 : n.fields.byMember().every((r) => {
        ...
        if (r.repeated) {
          ...
          switch (r.kind) {
            ...
            case "scalar":
              return i.every((c, u) => os(r.T, c, o[u]));
            case "enum":
              return i.every((c, u) => os(v.INT32, c, o[u]));
          }
        ...
        switch (r.kind) {
          ...
          case "oneof":
            ...
            switch (c.kind) {
              ...
              case "enum":
                return os(v.INT32, i.value, o.value);
              case "scalar":
                return os(c.T, i.value, o.value);
            }
          ...
          case "map":
            ...
            switch (r.V.kind) {
              ...
              case "enum":
                return u.every((h) => os(v.INT32, i[h], o[h]));
              case "scalar":
                const m = r.V.T;
                return u.every((h) => os(m, i[h], o[h]));
            }
            break;
        }
      });
...
const vd = /* @__PURE__ */ new Set([
  ...
  "toObject"
]), Nf = (n) => `${n}$`, Fd = (n) => Jd.has(n) ? Nf(n) : n, Ad = (n) => vd.has(n) ? Nf(n) : n;
class Ud {
  constructor(e) {
    this.kind = "oneof", this.repeated = !1, this.packed = !1, this.opt = !1, this.default = void 0, this.fields = [], this.name = e, this.localName = Od(e);
  }
  addField(e) {
...
const s = sd("proto3", Bd(), Td(), Object.assign(Object.assign({}, kd()), {
  newFieldList(n) {
    return new Id(n, Ld);
  },
  initFields(n) {
...
function Ld(n) {
  ...
  for (const c of typeof n == "function" ? n() : n) {
    const u = c;
    if (u.localName = Tf(c.name, c.oneof !== void 0), u.jsonName = (e = c.jsonName) !== null && e !== void 0 ? e : Sd(c.name), u.repeated = (t = c.repeated) !== null && t !== void 0 ? t : !1, u.packed = (r = c.packed) !== null && r !== void 0 ? r : c.kind == "enum" || c.kind == "scalar" && c.T != v.BYTES && c.T != v.STRING, c.oneof !== void 0) {
      const f = typeof c.oneof == "string" ? c.oneof : c.oneof.name;
      (!o || o.name != f) && (o = new Ud(f)), u.oneof = o, o.addField(u);
    }
    i.push(u);
  }
  return i;
...
mn.runtime = s;
mn.typeName = "google.protobuf.Duration";
...
dn.runtime = s;
dn.typeName = "code.common.v1.InstructionAccount";
...
qt.runtime = s;
qt.typeName = "code.common.v1.Transaction";
...
Pt.runtime = s;
Pt.typeName = "code.common.v1.Blockhash";
...
Pe.runtime = s;
Pe.typeName = "code.common.v1.IntentId";
...
ns.runtime = s;
ns.typeName = "code.common.v1.Hash";
...
hn.runtime = s;
hn.typeName = "code.common.v1.Request";
...
class pn extends N {
  constructor(e) {
    super(), this.result = No.OK, this.body = new Uint8Array(0), this.message = "", s.util.initPartial(e, this);
  }
  static fromBinary(e, t) {
...
pn.runtime = s;
pn.typeName = "code.common.v1.Response";
pn.fields = s.util.newFieldList(() => [
  { no: 1, name: "result", kind: "enum", T: s.getEnumType(No) },
...
s.util.setEnumType(No, "code.common.v1.Response.Result", [
  { no: 0, name: "OK" },
  { no: 1, name: "ERROR" }
]);
var sn;
...
s.util.setEnumType(sn, "code.transaction.v2.AirdropType", [
  { no: 0, name: "UNKNOWN" },
...
gn.runtime = s;
gn.typeName = "code.transaction.v2.SubmitIntentRequest";
gn.fields = s.util.newFieldList(() => [
  { no: 1, name: "submit_actions", kind: "message", T: wn, oneof: "request" },
  { no: 2, name: "submit_signatures", kind: "message", T: yn, oneof: "request" }
]);
class wn extends N {
  constructor(e) {
...
wn.runtime = s;
wn.typeName = "code.transaction.v2.SubmitIntentRequest.SubmitActions";
wn.fields = s.util.newFieldList(() => [
  { no: 1, name: "id", kind: "message", T: Pe },
  { no: 2, name: "owner", kind: "message", T: L },
  { no: 3, name: "metadata", kind: "message", T: xt },
  { no: 4, name: "actions", kind: "message", T: Gn, repeated: !0 },
...
yn.runtime = s;
yn.typeName = "code.transaction.v2.SubmitIntentRequest.SubmitSignatures";
...
Tn.runtime = s;
Tn.typeName = "code.transaction.v2.SubmitIntentResponse";
...
En.fields = s.util.newFieldList(() => [
  { no: 1, name: "server_parameters", kind: "message", T: ur, repeated: !0 }
]);
class Nn extends N {
  constructor(e) {
    super(), this.code = bo.OK, s.util.initPartial(e, this);
  }
  static fromBinary(e, t) {
...
s.util.setEnumType(bo, "code.transaction.v2.SubmitIntentResponse.Success.Code", [
  { no: 0, name: "OK" }
]);
class bn extends N {
  constructor(e) {
    super(), this.code = xo.DENIED, this.errorDetails = [], s.util.initPartial(e, this);
  }
  static fromBinary(e, t) {
...
bn.fields = s.util.newFieldList(() => [
  { no: 1, name: "code", kind: "enum", T: s.getEnumType(xo) },
...
s.util.setEnumType(xo, "code.transaction.v2.SubmitIntentResponse.Error.Code", [
  { no: 0, name: "DENIED" },
...
xn.runtime = s;
xn.typeName = "code.transaction.v2.GetIntentMetadataRequest";
xn.fields = s.util.newFieldList(() => [
  { no: 1, name: "intent_id", kind: "message", T: Pe },
  { no: 2, name: "owner", kind: "message", T: L },
...
Bn.fields = s.util.newFieldList(() => [
  ...
  { no: 2, name: "metadata", kind: "message", T: xt }
]);
var Bo;
(function(n) {
  n[n.OK = 0] = "OK", n[n.NOT_FOUND = 1] = "NOT_FOUND";
})(Bo || (Bo = {}));
s.util.setEnumType(Bo, "code.transaction.v2.GetIntentMetadataResponse.Result", [
  { no: 0, name: "OK" },
  { no: 1, name: "NOT_FOUND" }
]);
class kn extends N {
...
kn.runtime = s;
kn.typeName = "code.transaction.v2.GetPrivacyUpgradeStatusRequest";
...
class In extends N {
  constructor(e) {
    super(), this.result = ko.OK, this.status = Io.UNKNOWN, s.util.initPartial(e, this);
  }
  static fromBinary(e, t) {
...
In.runtime = s;
In.typeName = "code.transaction.v2.GetPrivacyUpgradeStatusResponse";
...
s.util.setEnumType(ko, "code.transaction.v2.GetPrivacyUpgradeStatusResponse.Result", [
  { no: 0, name: "OK" },
...
s.util.setEnumType(Io, "code.transaction.v2.GetPrivacyUpgradeStatusResponse.Status", [
  { no: 0, name: "UNKNOWN" },
...
On.runtime = s;
On.typeName = "code.transaction.v2.GetPrioritizedIntentsForPrivacyUpgradeRequest";
...
Sn.runtime = s;
Sn.typeName = "code.transaction.v2.GetPrioritizedIntentsForPrivacyUpgradeResponse";
...
vn.runtime = s;
vn.typeName = "code.transaction.v2.GetLimitsRequest";
...
class Jn extends N {
  constructor(e) {
    super(), this.result = So.OK, this.remainingSendLimitsByCurrency = {}, this.microPaymentLimitsByCurrency = {}, s.util.initPartial(e, this);
  }
  static fromBinary(e, t) {
...
Jn.runtime = s;
Jn.typeName = "code.transaction.v2.GetLimitsResponse";
Jn.fields = s.util.newFieldList(() => [
  { no: 1, name: "result", kind: "enum", T: s.getEnumType(So) },
  { no: 2, name: "remaining_send_limits_by_currency", kind: "map", K: 9, V: { kind: "message", T: Br } },
  { no: 3, name: "deposit_limit", kind: "message", T: kr },
  { no: 4, name: "micro_payment_limits_by_currency", kind: "map", K: 9, V: { kind: "message", T: Ir } }
]);
var So;
(function(n) {
  n[n.OK = 0] = "OK";
})(So || (So = {}));
s.util.setEnumType(So, "code.transaction.v2.GetLimitsResponse.Result", [
  { no: 0, name: "OK" }
]);
class Fn extends N {
  constructor(e) {
    super(), this.pageSize = 0, this.direction = vo.ASC, s.util.initPartial(e, this);
  }
  static fromBinary(e, t) {
...
Fn.runtime = s;
Fn.typeName = "code.transaction.v2.GetPaymentHistoryRequest";
Fn.fields = s.util.newFieldList(() => [
  { no: 1, name: "owner", kind: "message", T: L },
  { no: 2, name: "cursor", kind: "message", T: va },
  { no: 3, name: "page_size", kind: "scalar", T: 13 },
  { no: 4, name: "direction", kind: "enum", T: s.getEnumType(vo) },
  { no: 5, name: "signature", kind: "message", T: G }
]);
var vo;
(function(n) {
...
s.util.setEnumType(vo, "code.transaction.v2.GetPaymentHistoryRequest.Direction", [
  { no: 0, name: "ASC" },
  { no: 1, name: "DESC" }
]);
class An extends N {
  constructor(e) {
    super(), this.result = Jo.OK, this.items = [], s.util.initPartial(e, this);
  }
  static fromBinary(e, t) {
...
An.runtime = s;
An.typeName = "code.transaction.v2.GetPaymentHistoryResponse";
An.fields = s.util.newFieldList(() => [
  { no: 1, name: "result", kind: "enum", T: s.getEnumType(Jo) },
  { no: 2, name: "items", kind: "message", T: xr, repeated: !0 }
]);
var Jo;
(function(n) {
  n[n.OK = 0] = "OK", n[n.NOT_FOUND = 1] = "NOT_FOUND";
})(Jo || (Jo = {}));
s.util.setEnumType(Jo, "code.transaction.v2.GetPaymentHistoryResponse.Result", [
  { no: 0, name: "OK" },
  { no: 1, name: "NOT_FOUND" }
]);
class Un extends N {
...
Un.runtime = s;
Un.typeName = "code.transaction.v2.CanWithdrawToAccountRequest";
Un.fields = s.util.newFieldList(() => [
  { no: 1, name: "account", kind: "message", T: L }
]);
class Ln extends N {
  constructor(e) {
    super(), this.accountType = Fo.Unknown, this.isValidPaymentDestination = !1, this.requiresInitialization = !1, s.util.initPartial(e, this);
  }
  static fromBinary(e, t) {
...
Ln.runtime = s;
Ln.typeName = "code.transaction.v2.CanWithdrawToAccountResponse";
Ln.fields = s.util.newFieldList(() => [
  { no: 2, name: "account_type", kind: "enum", T: s.getEnumType(Fo) },
...
s.util.setEnumType(Fo, "code.transaction.v2.CanWithdrawToAccountResponse.AccountType", [
  { no: 0, name: "Unknown" },
...
class Dn extends N {
  constructor(e) {
    super(), this.airdropType = sn.UNKNOWN, s.util.initPartial(e, this);
  }
  static fromBinary(e, t) {
    return new Dn().fromBinary(e, t);
  }
...
Dn.runtime = s;
Dn.typeName = "code.transaction.v2.AirdropRequest";
Dn.fields = s.util.newFieldList(() => [
  { no: 1, name: "airdrop_type", kind: "enum", T: s.getEnumType(sn) },
  { no: 2, name: "owner", kind: "message", T: L },
  { no: 3, name: "signature", kind: "message", T: G }
]);
class Cn extends N {
  constructor(e) {
    super(), this.result = Ao.OK, s.util.initPartial(e, this);
  }
  static fromBinary(e, t) {
...
Cn.runtime = s;
Cn.typeName = "code.transaction.v2.AirdropResponse";
...
s.util.setEnumType(Ao, "code.transaction.v2.AirdropResponse.Result", [
  { no: 0, name: "OK" },
...
qn.runtime = s;
qn.typeName = "code.transaction.v2.SwapRequest";
qn.fields = s.util.newFieldList(() => [
  { no: 1, name: "initiate", kind: "message", T: Pn, oneof: "request" },
...
Pn.runtime = s;
Pn.typeName = "code.transaction.v2.SwapRequest.Initiate";
Pn.fields = s.util.newFieldList(() => [
  { no: 1, name: "owner", kind: "message", T: L },
...
_n.runtime = s;
_n.typeName = "code.transaction.v2.SwapResponse";
_n.fields = s.util.newFieldList(() => [
  { no: 1, name: "server_paramenters", kind: "message", T: $n, oneof: "response" },
  { no: 2, name: "success", kind: "message", T: Mn, oneof: "response" },
  { no: 3, name: "error", kind: "message", T: Vn, oneof: "response" }
]);
class $n extends N {
  constructor(e) {
...
$n.runtime = s;
$n.typeName = "code.transaction.v2.SwapResponse.ServerParameters";
$n.fields = s.util.newFieldList(() => [
  { no: 1, name: "payer", kind: "message", T: L },
  { no: 2, name: "recent_blockhash", kind: "message", T: Pt },
  ...
  { no: 6, name: "swap_ixn_accounts", kind: "message", T: dn, repeated: !0 },
...
class Mn extends N {
  constructor(e) {
    super(), this.code = Uo.SWAP_SUBMITTED, s.util.initPartial(e, this);
  }
  static fromBinary(e, t) {
    return new Mn().fromBinary(e, t);
  }
...
Mn.runtime = s;
Mn.typeName = "code.transaction.v2.SwapResponse.Success";
Mn.fields = s.util.newFieldList(() => [
...
s.util.setEnumType(Uo, "code.transaction.v2.SwapResponse.Success.Code", [
  { no: 0, name: "SWAP_SUBMITTED" },
  { no: 1, name: "SWAP_FINALIZED" }
]);
class Vn extends N {
  constructor(e) {
    super(), this.code = Lo.DENIED, this.errorDetails = [], s.util.initPartial(e, this);
  }
  static fromBinary(e, t) {
    return new Vn().fromBinary(e, t);
  }
...
Vn.runtime = s;
Vn.typeName = "code.transaction.v2.SwapResponse.Error";
Vn.fields = s.util.newFieldList(() => [
  { no: 1, name: "code", kind: "enum", T: s.getEnumType(Lo) },
  { no: 2, name: "error_details", kind: "message", T: $t, repeated: !0 }
]);
var Lo;
(function(n) {
...
s.util.setEnumType(Lo, "code.transaction.v2.SwapResponse.Error.Code", [
  { no: 0, name: "DENIED" },
  { no: 2, name: "SIGNATURE_ERROR" },
...
xt.runtime = s;
xt.typeName = "code.transaction.v2.Metadata";
xt.fields = s.util.newFieldList(() => [
  { no: 1, name: "open_accounts", kind: "message", T: Hn, oneof: "type" },
  { no: 2, name: "send_private_payment", kind: "message", T: jn, oneof: "type" },
  { no: 3, name: "receive_payments_privately", kind: "message", T: Wn, oneof: "type" },
  { no: 4, name: "upgrade_privacy", kind: "message", T: Yn, oneof: "type" },
  { no: 5, name: "migrate_to_privacy_2022", kind: "message", T: Xn, oneof: "type" },
  { no: 6, name: "send_public_payment", kind: "message", T: zn, oneof: "type" },
  { no: 7, name: "receive_payments_publicly", kind: "message", T: Rn, oneof: "type" },
  { no: 8, name: "establish_relationship", kind: "message", T: Zn, oneof: "type" }
]);
class Hn extends N {
  constructor(e) {
    super(), s.util.initPartial(e, this);
...
Hn.runtime = s;
Hn.typeName = "code.transaction.v2.OpenAccountsMetadata";
Hn.fields = s.util.newFieldList(() => []);
class jn extends N {
  constructor(e) {
...
zn.runtime = s;
zn.typeName = "code.transaction.v2.SendPublicPaymentMetadata";
...
Wn.runtime = s;
Wn.typeName = "code.transaction.v2.ReceivePaymentsPrivatelyMetadata";
Wn.fields = s.util.newFieldList(() => [
...
Rn.runtime = s;
Rn.typeName = "code.transaction.v2.ReceivePaymentsPubliclyMetadata";
...
Yn.runtime = s;
Yn.typeName = "code.transaction.v2.UpgradePrivacyMetadata";
Yn.fields = s.util.newFieldList(() => []);
class Xn extends N {
  constructor(e) {
...
Xn.runtime = s;
Xn.typeName = "code.transaction.v2.MigrateToPrivacy2022Metadata";
Xn.fields = s.util.newFieldList(() => [
...
Zn.runtime = s;
Zn.typeName = "code.transaction.v2.EstablishRelationshipMetadata";
Zn.fields = s.util.newFieldList(() => [
  { no: 1, name: "relationship", kind: "message", T: _t }
]);
class Gn extends N {
  constructor(e) {
...
Gn.runtime = s;
Gn.typeName = "code.transaction.v2.Action";
Gn.fields = s.util.newFieldList(() => [
  { no: 1, name: "id", kind: "scalar", T: 13 },
  { no: 2, name: "open_account", kind: "message", T: Qn, oneof: "type" },
  { no: 3, name: "close_empty_account", kind: "message", T: er, oneof: "type" },
  { no: 4, name: "close_dormant_account", kind: "message", T: tr, oneof: "type" },
  { no: 5, name: "no_privacy_transfer", kind: "message", T: nr, oneof: "type" },
  { no: 6, name: "no_privacy_withdraw", kind: "message", T: rr, oneof: "type" },
  { no: 7, name: "temporary_privacy_transfer", kind: "message", T: ir, oneof: "type" },
  { no: 8, name: "temporary_privacy_exchange", kind: "message", T: sr, oneof: "type" },
  { no: 9, name: "permanent_privacy_upgrade", kind: "message", T: or, oneof: "type" },
  { no: 10, name: "fee_payment", kind: "message", T: ar, oneof: "type" }
]);
class Qn extends N {
  constructor(e) {
...
Qn.runtime = s;
Qn.typeName = "code.transaction.v2.OpenAccountAction";
Qn.fields = s.util.newFieldList(() => [
...
er.runtime = s;
er.typeName = "code.transaction.v2.CloseEmptyAccountAction";
...
tr.runtime = s;
tr.typeName = "code.transaction.v2.CloseDormantAccountAction";
...
nr.runtime = s;
nr.typeName = "code.transaction.v2.NoPrivacyTransferAction";
...
rr.runtime = s;
rr.typeName = "code.transaction.v2.NoPrivacyWithdrawAction";
...
ir.runtime = s;
ir.typeName = "code.transaction.v2.TemporaryPrivacyTransferAction";
...
sr.runtime = s;
sr.typeName = "code.transaction.v2.TemporaryPrivacyExchangeAction";
...
or.runtime = s;
or.typeName = "code.transaction.v2.PermanentPrivacyUpgradeAction";
...
ar.runtime = s;
ar.typeName = "code.transaction.v2.FeePaymentAction";
...
ur.runtime = s;
ur.typeName = "code.transaction.v2.ServerParameter";
ur.fields = s.util.newFieldList(() => [
  { no: 1, name: "action_id", kind: "scalar", T: 13 },
  { no: 2, name: "nonces", kind: "message", T: cr, repeated: !0 },
  { no: 3, name: "open_account", kind: "message", T: lr, oneof: "type" },
  { no: 4, name: "close_empty_account", kind: "message", T: fr, oneof: "type" },
  { no: 5, name: "close_dormant_account", kind: "message", T: mr, oneof: "type" },
  { no: 6, name: "no_privacy_transfer", kind: "message", T: dr, oneof: "type" },
  { no: 7, name: "no_privacy_withdraw", kind: "message", T: hr, oneof: "type" },
  { no: 8, name: "temporary_privacy_transfer", kind: "message", T: pr, oneof: "type" },
  { no: 9, name: "temporary_privacy_exchange", kind: "message", T: gr, oneof: "type" },
  { no: 10, name: "permanent_privacy_upgrade", kind: "message", T: wr, oneof: "type" },
  { no: 11, name: "fee_payment", kind: "message", T: yr, oneof: "type" }
]);
class cr extends N {
  constructor(e) {
    super(), s.util.initPartial(e, this);
...
cr.runtime = s;
cr.typeName = "code.transaction.v2.NoncedTransactionMetadata";
cr.fields = s.util.newFieldList(() => [
  { no: 1, name: "nonce", kind: "message", T: L },
  { no: 2, name: "blockhash", kind: "message", T: Pt }
]);
class lr extends N {
  constructor(e) {
    super(), s.util.initPartial(e, this);
...
lr.runtime = s;
lr.typeName = "code.transaction.v2.OpenAccountServerParameter";
...
fr.runtime = s;
fr.typeName = "code.transaction.v2.CloseEmptyAccountServerParameter";
...
mr.runtime = s;
mr.typeName = "code.transaction.v2.CloseDormantAccountServerParameter";
...
dr.runtime = s;
dr.typeName = "code.transaction.v2.NoPrivacyTransferServerParameter";
...
hr.runtime = s;
hr.typeName = "code.transaction.v2.NoPrivacyWithdrawServerParameter";
...
pr.runtime = s;
pr.typeName = "code.transaction.v2.TemporaryPrivacyTransferServerParameter";
pr.fields = s.util.newFieldList(() => [
  { no: 1, name: "treasury", kind: "message", T: L },
  { no: 2, name: "recent_root", kind: "message", T: ns }
]);
class gr extends N {
  constructor(e) {
    super(), s.util.initPartial(e, this);
...
gr.runtime = s;
gr.typeName = "code.transaction.v2.TemporaryPrivacyExchangeServerParameter";
...
wr.runtime = s;
wr.typeName = "code.transaction.v2.PermanentPrivacyUpgradeServerParameter";
wr.fields = s.util.newFieldList(() => [
  { no: 1, name: "new_commitment", kind: "message", T: L },
  { no: 2, name: "new_commitment_transcript", kind: "message", T: ns },
  { no: 3, name: "new_commitment_destination", kind: "message", T: L },
  { no: 4, name: "new_commitment_amount", kind: "scalar", T: 4 },
  { no: 5, name: "merkle_root", kind: "message", T: ns },
  { no: 6, name: "merkle_proof", kind: "message", T: ns, repeated: !0 }
]);
class yr extends N {
  constructor(e) {
    super(), s.util.initPartial(e, this);
...
yr.runtime = s;
yr.typeName = "code.transaction.v2.FeePaymentServerParameter";
...
$t.fields = s.util.newFieldList(() => [
  ...
  { no: 2, name: "invalid_signature", kind: "message", T: Er, oneof: "type" }
]);
class Tr extends N {
  constructor(e) {
...
Er.runtime = s;
Er.typeName = "code.transaction.v2.InvalidSignatureErrorDetails";
Er.fields = s.util.newFieldList(() => [
  { no: 1, name: "action_id", kind: "scalar", T: 13 },
  { no: 2, name: "expected_transaction", kind: "message", T: qt },
...
Nr.runtime = s;
Nr.typeName = "code.transaction.v2.UpgradeableIntent";
Nr.fields = s.util.newFieldList(() => [
  { no: 1, name: "id", kind: "message", T: Pe },
  { no: 2, name: "actions", kind: "message", T: br, repeated: !0 }
]);
class br extends N {
  constructor(e) {
...
br.runtime = s;
br.typeName = "code.transaction.v2.UpgradeableIntent.UpgradeablePrivateAction";
br.fields = s.util.newFieldList(() => [
  { no: 1, name: "transaction_blob", kind: "message", T: qt },
  ...
  { no: 9, name: "recent_root", kind: "message", T: ns }
]);
class xr extends N {
  constructor(e) {
    super(), this.paymentType = Do.UNKNOWN, this.isWithdraw = !1, this.isDeposit = !1, this.isRemoteSend = !1, this.isReturned = !1, this.isAirdrop = !1, this.airdropType = sn.UNKNOWN, this.isMicroPayment = !1, s.util.initPartial(e, this);
  }
  static fromBinary(e, t) {
...
xr.runtime = s;
xr.typeName = "code.transaction.v2.PaymentHistoryItem";
xr.fields = s.util.newFieldList(() => [
  { no: 1, name: "cursor", kind: "message", T: va },
  { no: 2, name: "exchange_data", kind: "message", T: Me },
  { no: 3, name: "payment_type", kind: "enum", T: s.getEnumType(Do) },
  ...
  { no: 10, name: "airdrop_type", kind: "enum", T: s.getEnumType(sn) },
  { no: 11, name: "is_micro_payment", kind: "scalar", T: 8 },
  { no: 12, name: "intent_id", kind: "message", T: Pe }
]);
var Do;
(function(n) {
  n[n.UNKNOWN = 0] = "UNKNOWN", n[n.SEND = 1] = "SEND", n[n.RECEIVE = 2] = "RECEIVE";
})(Do || (Do = {}));
s.util.setEnumType(Do, "code.transaction.v2.PaymentHistoryItem.PaymentType", [
  { no: 0, name: "UNKNOWN" },
  { no: 1, name: "SEND" },
  { no: 2, name: "RECEIVE" }
]);
...
kr.runtime = s;
kr.typeName = "code.transaction.v2.DepositLimit";
...
Or.runtime = s;
Or.typeName = "code.account.v1.IsCodeAccountRequest";
Or.fields = s.util.newFieldList(() => [
  { no: 1, name: "owner", kind: "message", T: L },
  { no: 2, name: "signature", kind: "message", T: G }
]);
...
Sr.runtime = s;
Sr.typeName = "code.account.v1.IsCodeAccountResponse";
Sr.fields = s.util.newFieldList(() => [
...
s.util.setEnumType(Co, "code.account.v1.IsCodeAccountResponse.Result", [
  { no: 0, name: "OK" },
  { no: 1, name: "NOT_FOUND" },
...
vr.runtime = s;
vr.typeName = "code.account.v1.GetTokenAccountInfosRequest";
...
class Jr extends N {
  constructor(e) {
    super(), this.result = qo.OK, this.tokenAccountInfos = {}, s.util.initPartial(e, this);
  }
  static fromBinary(e, t) {
...
Jr.runtime = s;
Jr.typeName = "code.account.v1.GetTokenAccountInfosResponse";
Jr.fields = s.util.newFieldList(() => [
  { no: 1, name: "result", kind: "enum", T: s.getEnumType(qo) },
  { no: 2, name: "token_account_infos", kind: "map", K: 9, V: { kind: "message", T: Fr } }
]);
var qo;
(function(n) {
  n[n.OK = 0] = "OK", n[n.NOT_FOUND = 1] = "NOT_FOUND";
})(qo || (qo = {}));
s.util.setEnumType(qo, "code.account.v1.GetTokenAccountInfosResponse.Result", [
  { no: 0, name: "OK" },
  { no: 1, name: "NOT_FOUND" }
]);
class Fr extends N {
  constructor(e) {
    super(), this.accountType = lt.UNKNOWN, this.index = oe.zero, this.balanceSource = Po.UNKNOWN, this.balance = oe.zero, this.managementState = Ko.UNKNOWN, this.blockchainState = _o.UNKNOWN, this.mustRotate = !1, this.claimState = $o.UNKNOWN, this.mintDecimals = 0, this.mintDisplayName = "", s.util.initPartial(e, this);
  }
  static fromBinary(e, t) {
    return new Fr().fromBinary(e, t);
  }
...
Fr.runtime = s;
Fr.typeName = "code.account.v1.TokenAccountInfo";
Fr.fields = s.util.newFieldList(() => [
  ...
  { no: 6, name: "balance_source", kind: "enum", T: s.getEnumType(Po) },
  { no: 7, name: "balance", kind: "scalar", T: 4 },
  { no: 8, name: "management_state", kind: "enum", T: s.getEnumType(Ko) },
  { no: 9, name: "blockchain_state", kind: "enum", T: s.getEnumType(_o) },
  ...
  { no: 16, name: "relationship", kind: "message", T: _t }
]);
var Po;
(function(n) {
  n[n.UNKNOWN = 0] = "UNKNOWN", n[n.BLOCKCHAIN = 1] = "BLOCKCHAIN", n[n.CACHE = 2] = "CACHE";
})(Po || (Po = {}));
s.util.setEnumType(Po, "code.account.v1.TokenAccountInfo.BalanceSource", [
...
s.util.setEnumType(_o, "code.account.v1.TokenAccountInfo.BlockchainState", [
...
Ar.runtime = s;
Ar.typeName = "code.badge.v1.ResetBadgeCountRequest";
Ar.fields = s.util.newFieldList(() => [
  { no: 1, name: "owner", kind: "message", T: L },
  { no: 2, name: "signature", kind: "message", T: G }
]);
class Ur extends N {
  constructor(e) {
    super(), this.result = Mo.OK, s.util.initPartial(e, this);
  }
  static fromBinary(e, t) {
    return new Ur().fromBinary(e, t);
  }
...
Ur.runtime = s;
Ur.typeName = "code.badge.v1.ResetBadgeCountResponse";
Ur.fields = s.util.newFieldList(() => [
...
s.util.setEnumType(Mo, "code.badge.v1.ResetBadgeCountResponse.Result", [
  { no: 0, name: "OK" }
]);
ne.Unary;
class Lr extends N {
...
Lr.runtime = s;
Lr.typeName = "code.chat.v1.GetChatsRequest";
Lr.fields = s.util.newFieldList(() => [
  { no: 1, name: "owner", kind: "message", T: L },
  { no: 2, name: "signature", kind: "message", T: G },
  { no: 3, name: "page_size", kind: "scalar", T: 13 },
  { no: 4, name: "cursor", kind: "message", T: ht },
  { no: 5, name: "direction", kind: "enum", T: s.getEnumType(Vo) }
]);
var Vo;
(function(n) {
  n[n.ASC = 0] = "ASC", n[n.DESC = 1] = "DESC";
})(Vo || (Vo = {}));
s.util.setEnumType(Vo, "code.chat.v1.GetChatsRequest.Direction", [
  { no: 0, name: "ASC" },
  { no: 1, name: "DESC" }
]);
class Dr extends N {
  constructor(e) {
    super(), this.result = Ho.OK, this.chats = [], s.util.initPartial(e, this);
  }
  static fromBinary(e, t) {
    return new Dr().fromBinary(e, t);
  }
...
Dr.runtime = s;
Dr.typeName = "code.chat.v1.GetChatsResponse";
Dr.fields = s.util.newFieldList(() => [
...
s.util.setEnumType(Ho, "code.chat.v1.GetChatsResponse.Result", [
  { no: 0, name: "OK" },
  { no: 1, name: "NOT_FOUND" }
]);
class Cr extends N {
  constructor(e) {
    super(), this.pageSize = 0, this.direction = jo.ASC, s.util.initPartial(e, this);
  }
  static fromBinary(e, t) {
    return new Cr().fromBinary(e, t);
  }
...
Cr.runtime = s;
Cr.typeName = "code.chat.v1.GetMessagesRequest";
Cr.fields = s.util.newFieldList(() => [
  ...
  { no: 6, name: "direction", kind: "enum", T: s.getEnumType(jo) }
]);
var jo;
(function(n) {
  n[n.ASC = 0] = "ASC", n[n.DESC = 1] = "DESC";
})(jo || (jo = {}));
s.util.setEnumType(jo, "code.chat.v1.GetMessagesRequest.Direction", [
  { no: 0, name: "ASC" },
  { no: 1, name: "DESC" }
]);
class qr extends N {
  constructor(e) {
    super(), this.result = zo.OK, this.messages = [], s.util.initPartial(e, this);
  }
  static fromBinary(e, t) {
...
qr.runtime = s;
qr.typeName = "code.chat.v1.GetMessagesResponse";
qr.fields = s.util.newFieldList(() => [
  { no: 1, name: "result", kind: "enum", T: s.getEnumType(zo) },
  { no: 2, name: "messages", kind: "message", T: jr, repeated: !0 }
]);
var zo;
(function(n) {
  n[n.OK = 0] = "OK", n[n.NOT_FOUND = 1] = "NOT_FOUND";
})(zo || (zo = {}));
s.util.setEnumType(zo, "code.chat.v1.GetMessagesResponse.Result", [
  { no: 0, name: "OK" },
  { no: 1, name: "NOT_FOUND" }
]);
class Pr extends N {
...
Pr.runtime = s;
Pr.typeName = "code.chat.v1.AdvancePointerRequest";
Pr.fields = s.util.newFieldList(() => [
  { no: 1, name: "chat_id", kind: "message", T: ut },
  { no: 2, name: "pointer", kind: "message", T: Vt },
...
Kr.runtime = s;
Kr.typeName = "code.chat.v1.AdvancePointerResponse";
Kr.fields = s.util.newFieldList(() => [
...
s.util.setEnumType(Wo, "code.chat.v1.AdvancePointerResponse.Result", [
  { no: 0, name: "OK" },
...
_r.runtime = s;
_r.typeName = "code.chat.v1.SetMuteStateRequest";
...
$r.runtime = s;
$r.typeName = "code.chat.v1.SetMuteStateResponse";
...
s.util.setEnumType(Ro, "code.chat.v1.SetMuteStateResponse.Result", [
  { no: 0, name: "OK" },
  { no: 1, name: "CHAT_NOT_FOUND" },
  { no: 2, name: "CANT_MUTE" }
]);
...
Mr.runtime = s;
Mr.typeName = "code.chat.v1.SetSubscriptionStateRequest";
Mr.fields = s.util.newFieldList(() => [
  { no: 1, name: "chat_id", kind: "message", T: ut },
...
Vr.runtime = s;
Vr.typeName = "code.chat.v1.SetSubscriptionStateResponse";
Vr.fields = s.util.newFieldList(() => [
...
class Vt extends N {
  constructor(e) {
    super(), this.kind = Xo.UNKNOWN, s.util.initPartial(e, this);
  }
  static fromBinary(e, t) {
...
Vt.runtime = s;
Vt.typeName = "code.chat.v1.Pointer";
Vt.fields = s.util.newFieldList(() => [
  { no: 1, name: "kind", kind: "enum", T: s.getEnumType(Xo) },
...
s.util.setEnumType(Xo, "code.chat.v1.Pointer.Kind", [
  { no: 0, name: "UNKNOWN" },
  { no: 1, name: "READ" }
]);
class Hr extends N {
...
Hr.fields = s.util.newFieldList(() => [
  { no: 1, name: "chat_id", kind: "message", T: ut },
  { no: 2, name: "localized", kind: "message", T: Ht, oneof: "title" },
  { no: 3, name: "domain", kind: "message", T: at, oneof: "title" },
  { no: 4, name: "read_pointer", kind: "message", T: Vt },
...
jr.runtime = s;
jr.typeName = "code.chat.v1.ChatMessage";
jr.fields = s.util.newFieldList(() => [
  { no: 1, name: "message_id", kind: "message", T: Mt },
  { no: 2, name: "ts", kind: "message", T: Fe },
  { no: 3, name: "content", kind: "message", T: zr, repeated: !0 },
  { no: 4, name: "cursor", kind: "message", T: ht }
]);
class zr extends N {
  constructor(e) {
...
zr.runtime = s;
zr.typeName = "code.chat.v1.Content";
zr.fields = s.util.newFieldList(() => [
  { no: 1, name: "localized", kind: "message", T: Ht, oneof: "type" },
  { no: 2, name: "exchange_data", kind: "message", T: Wr, oneof: "type" },
  { no: 3, name: "nacl_box", kind: "message", T: Rr, oneof: "type" }
]);
class Ht extends N {
  constructor(e) {
...
Ht.runtime = s;
Ht.typeName = "code.chat.v1.LocalizedContent";
Ht.fields = s.util.newFieldList(() => [
  { no: 1, name: "key", kind: "scalar", T: 9 }
]);
class Wr extends N {
  constructor(e) {
    super(), this.verb = Zo.UNKNOWN, this.exchangeData = { case: void 0 }, s.util.initPartial(e, this);
  }
  static fromBinary(e, t) {
    return new Wr().fromBinary(e, t);
  }
...
Wr.runtime = s;
Wr.typeName = "code.chat.v1.ExchangeDataContent";
Wr.fields = s.util.newFieldList(() => [
  { no: 1, name: "verb", kind: "enum", T: s.getEnumType(Zo) },
...
s.util.setEnumType(Zo, "code.chat.v1.ExchangeDataContent.Verb", [
  { no: 0, name: "UNKNOWN" },
  { no: 1, name: "GAVE" },
  { no: 2, name: "RECEIVED" },
  { no: 3, name: "WITHDREW" },
...
Rr.runtime = s;
Rr.typeName = "code.chat.v1.NaclBoxEncryptedContent";
Rr.fields = s.util.newFieldList(() => [
...
Yr.runtime = s;
Yr.typeName = "code.contact.v1.AddContactsRequest";
Yr.fields = s.util.newFieldList(() => [
...
class Xr extends N {
  constructor(e) {
    super(), this.result = Go.OK, this.contactStatus = {}, s.util.initPartial(e, this);
  }
  static fromBinary(e, t) {
    return new Xr().fromBinary(e, t);
  }
...
Xr.runtime = s;
Xr.typeName = "code.contact.v1.AddContactsResponse";
Xr.fields = s.util.newFieldList(() => [
  { no: 1, name: "result", kind: "enum", T: s.getEnumType(Go) },
  { no: 2, name: "contact_status", kind: "map", K: 9, V: { kind: "message", T: jt } }
]);
var Go;
(function(n) {
  n[n.OK = 0] = "OK";
})(Go || (Go = {}));
s.util.setEnumType(Go, "code.contact.v1.AddContactsResponse.Result", [
  { no: 0, name: "OK" }
]);
class Zr extends N {
  constructor(e) {
...
Zr.runtime = s;
Zr.typeName = "code.contact.v1.RemoveContactsRequest";
Zr.fields = s.util.newFieldList(() => [
  { no: 1, name: "owner_account_id", kind: "message", T: L },
  { no: 2, name: "signature", kind: "message", T: G },
  { no: 3, name: "container_id", kind: "message", T: nt },
...
Gr.runtime = s;
Gr.typeName = "code.contact.v1.RemoveContactsResponse";
Gr.fields = s.util.newFieldList(() => [
  { no: 1, name: "result", kind: "enum", T: s.getEnumType(Qo) }
]);
var Qo;
...
s.util.setEnumType(Qo, "code.contact.v1.RemoveContactsResponse.Result", [
  { no: 0, name: "OK" }
]);
class Qr extends N {
  constructor(e) {
...
Qr.runtime = s;
Qr.typeName = "code.contact.v1.GetContactsRequest";
Qr.fields = s.util.newFieldList(() => [
  { no: 1, name: "owner_account_id", kind: "message", T: L },
  { no: 2, name: "signature", kind: "message", T: G },
  { no: 3, name: "container_id", kind: "message", T: nt },
...
class ei extends N {
  constructor(e) {
    super(), this.result = ea.OK, this.contacts = [], s.util.initPartial(e, this);
  }
  static fromBinary(e, t) {
...
ei.runtime = s;
ei.typeName = "code.contact.v1.GetContactsResponse";
ei.fields = s.util.newFieldList(() => [
  { no: 1, name: "result", kind: "enum", T: s.getEnumType(ea) },
  { no: 2, name: "contacts", kind: "message", T: ti, repeated: !0 },
...
s.util.setEnumType(ea, "code.contact.v1.GetContactsResponse.Result", [
  { no: 0, name: "OK" }
]);
class ti extends N {
  constructor(e) {
...
ti.runtime = s;
ti.typeName = "code.contact.v1.Contact";
ti.fields = s.util.newFieldList(() => [
  { no: 1, name: "phone_number", kind: "message", T: Ke },
  { no: 2, name: "status", kind: "message", T: jt }
]);
class jt extends N {
  constructor(e) {
...
jt.runtime = s;
jt.typeName = "code.contact.v1.ContactStatus";
...
ni.runtime = s;
ni.typeName = "code.currency.v1.GetAllRatesRequest";
ni.fields = s.util.newFieldList(() => [
  { no: 1, name: "timestamp", kind: "message", T: Fe }
]);
class ri extends N {
  constructor(e) {
    super(), this.result = ta.OK, this.rates = {}, s.util.initPartial(e, this);
  }
  static fromBinary(e, t) {
...
ri.runtime = s;
ri.typeName = "code.currency.v1.GetAllRatesResponse";
...
s.util.setEnumType(ta, "code.currency.v1.GetAllRatesResponse.Result", [
  { no: 0, name: "OK" },
...
ii.runtime = s;
ii.typeName = "code.device.v1.RegisterLoggedInAccountsRequest";
...
class si extends N {
  constructor(e) {
    super(), this.result = na.OK, this.invalidOwners = [], s.util.initPartial(e, this);
  }
  static fromBinary(e, t) {
...
si.runtime = s;
si.typeName = "code.device.v1.RegisterLoggedInAccountsResponse";
...
s.util.setEnumType(na, "code.device.v1.RegisterLoggedInAccountsResponse.Result", [
  { no: 0, name: "OK" },
...
oi.runtime = s;
oi.typeName = "code.device.v1.GetLoggedInAccountsRequest";
oi.fields = s.util.newFieldList(() => [
  { no: 1, name: "app_install", kind: "message", T: bt }
]);
class ai extends N {
  constructor(e) {
    super(), this.result = ra.OK, this.owners = [], s.util.initPartial(e, this);
  }
  static fromBinary(e, t) {
...
ai.runtime = s;
ai.typeName = "code.device.v1.GetLoggedInAccountsResponse";
...
s.util.setEnumType(ra, "code.device.v1.GetLoggedInAccountsResponse.Result", [
  { no: 0, name: "OK" }
]);
ne.Unary, ne.Unary;
var ia;
...
s.util.setEnumType(ia, "code.invite.v2.InvitationStatus", [
...
ui.runtime = s;
ui.typeName = "code.invite.v2.GetInviteCountRequest";
ui.fields = s.util.newFieldList(() => [
  { no: 1, name: "user_id", kind: "message", T: dt }
]);
class ci extends N {
  constructor(e) {
    super(), this.result = sa.OK, this.inviteCount = 0, s.util.initPartial(e, this);
  }
  static fromBinary(e, t) {
...
ci.runtime = s;
ci.typeName = "code.invite.v2.GetInviteCountResponse";
...
s.util.setEnumType(sa, "code.invite.v2.GetInviteCountResponse.Result", [
  { no: 0, name: "OK" }
]);
class li extends N {
  constructor(e) {
...
li.runtime = s;
li.typeName = "code.invite.v2.InvitePhoneNumberRequest";
li.fields = s.util.newFieldList(() => [
  { no: 1, name: "user", kind: "message", T: dt, oneof: "source" },
  { no: 3, name: "invite_code", kind: "message", T: hi, oneof: "source" },
  { no: 2, name: "receiver", kind: "message", T: Ke }
]);
class fi extends N {
  constructor(e) {
    super(), this.result = oa.OK, s.util.initPartial(e, this);
  }
  static fromBinary(e, t) {
...
fi.typeName = "code.invite.v2.InvitePhoneNumberResponse";
...
s.util.setEnumType(oa, "code.invite.v2.InvitePhoneNumberResponse.Result", [
  { no: 0, name: "OK" },
...
mi.runtime = s;
mi.typeName = "code.invite.v2.GetInvitationStatusRequest";
mi.fields = s.util.newFieldList(() => [
  { no: 1, name: "user_id", kind: "message", T: dt }
]);
class di extends N {
  constructor(e) {
    super(), this.result = aa.OK, this.status = ia.NOT_INVITED, s.util.initPartial(e, this);
  }
  static fromBinary(e, t) {
...
di.runtime = s;
di.typeName = "code.invite.v2.GetInvitationStatusResponse";
di.fields = s.util.newFieldList(() => [
  { no: 1, name: "result", kind: "enum", T: s.getEnumType(aa) },
  { no: 2, name: "status", kind: "enum", T: s.getEnumType(ia) }
]);
var aa;
(function(n) {
  n[n.OK = 0] = "OK";
})(aa || (aa = {}));
s.util.setEnumType(aa, "code.invite.v2.GetInvitationStatusResponse.Result", [
  { no: 0, name: "OK" }
]);
class hi extends N {
  constructor(e) {
...
hi.runtime = s;
hi.typeName = "code.invite.v2.InviteCode";
...
class ws extends N {
  ...
  static equals(e, t) {
    return s.util.equals(ws, e, t);
  }
}
ws.runtime = s;
ws.typeName = "code.invite.v2.PageToken";
ws.fields = s.util.newFieldList(() => [
  { no: 1, name: "value", kind: "scalar", T: 12 }
]);
ne.Unary, ne.Unary, ne.Unary;
class zt extends N {
...
zt.runtime = s;
zt.typeName = "code.messaging.v1.OpenMessageStreamRequest";
...
pi.runtime = s;
pi.typeName = "code.messaging.v1.OpenMessageStreamWithKeepAliveRequest";
pi.fields = s.util.newFieldList(() => [
  { no: 1, name: "request", kind: "message", T: zt, oneof: "requestOrPong" },
  { no: 2, name: "pong", kind: "message", T: Ji, oneof: "requestOrPong" }
]);
class gi extends N {
  constructor(e) {
...
gi.runtime = s;
gi.typeName = "code.messaging.v1.OpenMessageStreamWithKeepAliveResponse";
gi.fields = s.util.newFieldList(() => [
  { no: 1, name: "response", kind: "message", T: Wt, oneof: "responseOrPing" },
  { no: 2, name: "ping", kind: "message", T: vi, oneof: "responseOrPing" }
]);
class wi extends N {
  constructor(e) {
    super(), s.util.initPartial(e, this);
...
wi.runtime = s;
wi.typeName = "code.messaging.v1.PollMessagesRequest";
...
yi.runtime = s;
yi.typeName = "code.messaging.v1.PollMessagesResponse";
...
Ei.runtime = s;
Ei.typeName = "code.messaging.v1.AckMesssagesResponse";
Ei.fields = s.util.newFieldList(() => [
...
s.util.setEnumType(ua, "code.messaging.v1.AckMesssagesResponse.Result", [
  { no: 0, name: "OK" }
]);
class Rt extends N {
  constructor(e) {
...
Rt.runtime = s;
Rt.typeName = "code.messaging.v1.SendMessageRequest";
...
class Ni extends N {
  constructor(e) {
    super(), this.result = Gs.OK, s.util.initPartial(e, this);
  }
  static fromBinary(e, t) {
    return new Ni().fromBinary(e, t);
  }
...
Ni.runtime = s;
Ni.typeName = "code.messaging.v1.SendMessageResponse";
Ni.fields = s.util.newFieldList(() => [
  { no: 1, name: "result", kind: "enum", T: s.getEnumType(Gs) },
...
s.util.setEnumType(Gs, "code.messaging.v1.SendMessageResponse.Result", [
  { no: 0, name: "OK" },
...
bi.runtime = s;
bi.typeName = "code.messaging.v1.RequestToGrabBill";
...
xi.runtime = s;
xi.typeName = "code.messaging.v1.CodeScanned";
...
ki.runtime = s;
ki.typeName = "code.messaging.v1.IntentSubmitted";
...
Ii.runtime = s;
Ii.typeName = "code.messaging.v1.WebhookCalled";
Ii.fields = s.util.newFieldList(() => [
  { no: 1, name: "timestamp", kind: "message", T: Fe }
]);
class Xt extends N {
...
Oi.runtime = s;
Oi.typeName = "code.messaging.v1.ClientRejectedLogin";
Oi.fields = s.util.newFieldList(() => [
...
Si.runtime = s;
Si.typeName = "code.messaging.v1.AirdropReceived";
Si.fields = s.util.newFieldList(() => [
  { no: 1, name: "airdrop_type", kind: "enum", T: s.getEnumType(sn) },
  { no: 2, name: "exchange_data", kind: "message", T: Me },
...
it.fields = s.util.newFieldList(() => [
  ...
  { no: 2, name: "request_to_grab_bill", kind: "message", T: bi, oneof: "kind" },
  { no: 5, name: "request_to_receive_bill", kind: "message", T: Yt, oneof: "kind" },
  { no: 6, name: "code_scanned", kind: "message", T: xi, oneof: "kind" },
  { no: 7, name: "client_rejected_payment", kind: "message", T: Bi, oneof: "kind" },
  { no: 8, name: "intent_submitted", kind: "message", T: ki, oneof: "kind" },
  { no: 9, name: "webhook_called", kind: "message", T: Ii, oneof: "kind" },
  { no: 10, name: "request_to_login", kind: "message", T: Xt, oneof: "kind" },
  { no: 12, name: "client_rejected_login", kind: "message", T: Oi, oneof: "kind" },
  { no: 4, name: "airdrop_received", kind: "message", T: Si, oneof: "kind" }
]);
class vi extends N {
  constructor(e) {
    super(), s.util.initPartial(e, this);
...
vi.runtime = s;
vi.typeName = "code.messaging.v1.ServerPing";
vi.fields = s.util.newFieldList(() => [
  { no: 1, name: "timestamp", kind: "message", T: Fe },
  { no: 2, name: "ping_delay", kind: "message", T: mn }
]);
class Ji extends N {
  constructor(e) {
    super(), s.util.initPartial(e, this);
...
Ji.runtime = s;
Ji.typeName = "code.messaging.v1.ClientPong";
...
Zt.runtime = s;
Zt.typeName = "code.micropayment.v1.GetStatusRequest";
Zt.fields = s.util.newFieldList(() => [
  { no: 1, name: "intent_id", kind: "message", T: Pe }
]);
class Fi extends N {
...
Fi.runtime = s;
Fi.typeName = "code.micropayment.v1.GetStatusResponse";
Fi.fields = s.util.newFieldList(() => [
...
Gt.runtime = s;
Gt.typeName = "code.micropayment.v1.RegisterWebhookRequest";
...
class Ai extends N {
  constructor(e) {
    super(), this.result = Nt.OK, s.util.initPartial(e, this);
  }
  static fromBinary(e, t) {
    return new Ai().fromBinary(e, t);
  }
...
Ai.runtime = s;
Ai.typeName = "code.micropayment.v1.RegisterWebhookResponse";
Ai.fields = s.util.newFieldList(() => [
  { no: 1, name: "result", kind: "enum", T: s.getEnumType(Nt) }
]);
var Nt;
(function(n) {
...
s.util.setEnumType(Nt, "code.micropayment.v1.RegisterWebhookResponse.Result", [
  { no: 0, name: "OK" },
...
Ui.runtime = s;
Ui.typeName = "code.micropayment.v1.CodifyRequest";
Ui.fields = s.util.newFieldList(() => [
...
Li.runtime = s;
Li.typeName = "code.micropayment.v1.CodifyResponse";
Li.fields = s.util.newFieldList(() => [
...
Di.runtime = s;
Di.typeName = "code.micropayment.v1.GetPathMetadataRequest";
Di.fields = s.util.newFieldList(() => [
...
Ci.runtime = s;
Ci.typeName = "code.micropayment.v1.GetPathMetadataResponse";
Ci.fields = s.util.newFieldList(() => [
...
qi.runtime = s;
qi.typeName = "code.phone.v1.SendVerificationCodeRequest";
...
Pi.runtime = s;
Pi.typeName = "code.phone.v1.SendVerificationCodeResponse";
Pi.fields = s.util.newFieldList(() => [
...
_i.runtime = s;
_i.typeName = "code.phone.v1.CheckVerificationCodeResponse";
...
Mi.runtime = s;
Mi.typeName = "code.phone.v1.GetAssociatedPhoneNumberResponse";
Mi.fields = s.util.newFieldList(() => [
...
Hi.runtime = s;
Hi.typeName = "code.push.v1.AddTokenResponse";
Hi.fields = s.util.newFieldList(() => [
...
ji.runtime = s;
ji.typeName = "code.user.v1.LinkAccountRequest";
ji.fields = s.util.newFieldList(() => [
  { no: 1, name: "owner_account_id", kind: "message", T: L },
  { no: 2, name: "signature", kind: "message", T: G },
...
zi.runtime = s;
zi.typeName = "code.user.v1.LinkAccountResponse";
...
Wi.runtime = s;
Wi.typeName = "code.user.v1.UnlinkAccountRequest";
Wi.fields = s.util.newFieldList(() => [
  { no: 1, name: "owner_account_id", kind: "message", T: L },
  { no: 2, name: "signature", kind: "message", T: G },
...
Ri.runtime = s;
Ri.typeName = "code.user.v1.UnlinkAccountResponse";
Ri.fields = s.util.newFieldList(() => [
...
Xi.runtime = s;
Xi.typeName = "code.user.v1.GetUserResponse";
Xi.fields = s.util.newFieldList(() => [
  ...
  { no: 7, name: "eligible_airdrops", kind: "enum", T: s.getEnumType(sn), repeated: !0 }
]);
var ya;
(function(n) {
  n[n.OK = 0] = "OK", n[n.NOT_FOUND = 1] = "NOT_FOUND", n[n.NOT_INVITED = 2] = "NOT_INVITED", n[n.UNLOCKED_TIMELOCK_ACCOUNT = 3] = "UNLOCKED_TIMELOCK_ACCOUNT";
...
Zi.runtime = s;
Zi.typeName = "code.user.v1.LoginToThirdPartyAppRequest";
Zi.fields = s.util.newFieldList(() => [
  { no: 1, name: "intent_id", kind: "message", T: Pe },
...
Gi.runtime = s;
Gi.typeName = "code.user.v1.LoginToThirdPartyAppResponse";
Gi.fields = s.util.newFieldList(() => [
  { no: 1, name: "result", kind: "enum", T: s.getEnumType(Ta) }
]);
var Ta;
...
Qi.runtime = s;
Qi.typeName = "code.user.v1.GetLoginForThirdPartyAppRequest";
Qi.fields = s.util.newFieldList(() => [
  { no: 1, name: "intent_id", kind: "message", T: Pe },
...
es.runtime = s;
es.typeName = "code.user.v1.GetLoginForThirdPartyAppResponse";
...
tn.fields = s.util.newFieldList(() => [
  ...
  { no: 2, name: "view", kind: "message", T: ts }
]);
class ts extends N {
  constructor(e) {
    super(), s.util.initPartial(e, this);
...
function qd(n) {
  ...
  function h(b) {
    ...
    if (b.length === 0)
      return "";
    for (var O = 0, A = 0, M = 0, W = b.length; M !== W && b[M] === 0; )
      M++, O++;
    for (var me = (W - M) * m + 1 >>> 0, _ = new Uint8Array(me); M !== W; ) {
      for (var re = b[M], F = 0, R = me - 1; (re !== 0 || F < A) && R !== -1; R--, F++)
        re += 256 * _[R] >>> 0, _[R] = re % c >>> 0, re = re / c >>> 0;
      if (re !== 0)
        throw new Error("Non-zero carry");
      A = F, M++;
    }
    for (var Q = me - A; Q !== me && _[Q] === 0; )
      Q++;
    for (var te = u.repeat(O); Q < me; ++Q)
      te += n.charAt(_[Q]);
    return te;
  }
  function g(b) {
    ...
    for (var O = 0, A = 0, M = 0; b[O] === u; )
      A++, O++;
    for (var W = (b.length - O) * f + 1 >>> 0, me = new Uint8Array(W); b[O]; ) {
      var _ = e[b.charCodeAt(O)];
      if (_ === 255)
        return;
      for (var re = 0, F = W - 1; (_ !== 0 || re < M) && F !== -1; F--, re++)
        _ += c * me[F] >>> 0, me[F] = _ % 256 >>> 0, _ = _ / 256 >>> 0;
      if (_ !== 0)
        throw new Error("Non-zero carry");
      M = re, O++;
    }
    for (var R = W - M; R !== W && me[R] === 0; )
      R++;
    for (var Q = new Uint8Array(A + (W - R)), te = A; R !== W; )
      Q[te++] = me[R++];
    return Q;
  }
  function y(b) {
...
var Pd = qd;
const Kd = Pd, _d = "123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz";
var $d = Kd(_d);
const ru = /* @__PURE__ */ Cd($d);
var Bc = {}, wu = {};
wu.byteLength = Hd;
wu.toByteArray = zd;
wu.fromByteArray = Yd;
var Lt = [], ft = [], Md = typeof Uint8Array < "u" ? Uint8Array : Array, Cu = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";
for (var Ms = 0, Vd = Cu.length; Ms < Vd; ++Ms)
  Lt[Ms] = Cu[Ms], ft[Cu.charCodeAt(Ms)] = Ms;
ft["-".charCodeAt(0)] = 62;
...
function zd(n) {
  var e, t = xf(n), r = t[0], i = t[1], o = new Md(jd(n, r, i)), c = 0, u = i > 0 ? r - 4 : r, f;
  for (f = 0; f < u; f += 4)
...
function Wd(n) {
  return Lt[n >> 18 & 63] + Lt[n >> 12 & 63] + Lt[n >> 6 & 63] + Lt[n & 63];
}
function Rd(n, e, t) {
  for (var r, i = [], o = e; o < t; o += 3)
    r = (n[o] << 16 & 16711680) + (n[o + 1] << 8 & 65280) + (n[o + 2] & 255), i.push(Wd(r));
  return i.join("");
}
function Yd(n) {
  for (var e, t = n.length, r = t % 3, i = [], o = 16383, c = 0, u = t - r; c < u; c += o)
    i.push(Rd(n, c, c + o > u ? u : c + o));
...
kc.write = function(n, e, t, r, i, o) {
  var c, u, f, m = o * 8 - i - 1, h = (1 << m) - 1, g = h >> 1, y = i === 23 ? Math.pow(2, -24) - Math.pow(2, -77) : 0, b = r ? 0 : o - 1, O = r ? 1 : -1, A = e < 0 || e === 0 && 1 / e < 0 ? 1 : 0;
  for (e = Math.abs(e), isNaN(e) || e === 1 / 0 ? (u = isNaN(e) ? 1 : 0, c = h) : (c = Math.floor(Math.log(e) / Math.LN2), e * (f = Math.pow(2, -c)) < 1 && (c--, f *= 2), c + g >= 1 ? e += y / f : e += y * Math.pow(2, 1 - g), e * f >= 2 && (c++, f /= 2), c + g >= h ? (u = 0, c = h) : c + g >= 1 ? (u = (e * f - 1) * Math.pow(2, i), c = c + g) : (u = e * Math.pow(2, g - 1) * Math.pow(2, i), c = 0)); i >= 8; n[t + b] = u & 255, b += O, u /= 256, i -= 8)
    ;
  for (c = c << i | u, m += i; m > 0; n[t + b] = c & 255, b += O, c /= 256, m -= 8)
    ;
  n[t + b - O] |= A * 128;
};
/*!
...
(function(n) {
  ...
  function f(d, a, l) {
    ...
    if (I(d, ArrayBuffer) || d && I(d.buffer, ArrayBuffer) || typeof SharedArrayBuffer < "u" && (I(d, SharedArrayBuffer) || d && I(d.buffer, SharedArrayBuffer)))
      return A(d, a, l);
    if (typeof d == "number")
      throw new TypeError(
  ...
  u.isBuffer = function(a) {
    ...
    if (I(a, Uint8Array) && (a = u.from(a, a.offset, a.byteLength)), I(l, Uint8Array) && (l = u.from(l, l.offset, l.byteLength)), !u.isBuffer(a) || !u.isBuffer(l))
      throw new TypeError(
  ...
  function _(d, a) {
    if (u.isBuffer(d))
      return d.length;
    if (ArrayBuffer.isView(d) || I(d, ArrayBuffer))
      return d.byteLength;
    if (typeof d != "string")
      throw new TypeError(
  ...
  u.prototype.swap16 = function() {
    ...
    const a = this.length;
    return a === 0 ? "" : arguments.length === 0 ? an(this, 0, a) : re.apply(this, arguments);
    ...
    if (I(a, Uint8Array) && (a = u.from(a, a.offset, a.byteLength)), !u.isBuffer(a))
      throw new TypeError(
...
const Bf = (n) => n instanceof Uint8Array, Pu = (n) => new DataView(n.buffer, n.byteOffset, n.byteLength), Jt = (n, e) => n << 32 - e | n >>> e, Gd = new Uint8Array(new Uint32Array([287454020]).buffer)[0] === 68;
if (!Gd)
...
function If(n) {
  if (typeof n == "string" && (n = kf(n)), !Bf(n))
...
function Of(n) {
  const e = (r) => n().update(If(r)).digest(), t = n();
...
class Sf extends eh {
  constructor(e, t, r, i) {
    super(), this.blockLen = e, this.outputLen = t, this.padOffset = r, this.isLE = i, this.finished = !1, this.length = 0, this.pos = 0, this.destroyed = !1, this.buffer = new Uint8Array(e), this.view = Pu(this.buffer);
  }
  update(e) {
    dl(this);
  ...
  digestInto(e) {
    dl(this), Zd(e, this), this.finished = !0;
...
function rh(n, e = !1) {
  ...
  for (let i = 0; i < n.length; i++) {
    const { h: o, l: c } = vf(n[i], e);
    [t[i], r[i]] = [o, c];
  }
  return [t, r];
}
const ih = (n, e) => BigInt(n >>> 0) << Qu | BigInt(e >>> 0), sh = (n, e, t) => n >>> t, oh = (n, e, t) => n << 32 - t | e >>> t, ah = (n, e, t) => n >>> t | e << 32 - t, uh = (n, e, t) => n << 32 - t | e >>> t, ch = (n, e, t) => n << 64 - t | e >>> t - 32, lh = (n, e, t) => n >>> t - 32 | e << 64 - t, fh = (n, e) => e, mh = (n, e) => n, dh = (n, e, t) => n << t | e >>> 32 - t, hh = (n, e, t) => e << t | n >>> 32 - t, ph = (n, e, t) => e << t - 32 | n >>> 64 - t, gh = (n, e, t) => n << t - 32 | e >>> 64 - t;
function wh(n, e, t, r) {
  const i = (e >>> 0) + (r >>> 0);
  return { h: n + t + (i / 2 ** 32 | 0) | 0, l: i | 0 };
}
const yh = (n, e, t) => (n >>> 0) + (e >>> 0) + (t >>> 0), Th = (n, e, t, r) => e + t + r + (n / 2 ** 32 | 0) | 0, Eh = (n, e, t, r) => (n >>> 0) + (e >>> 0) + (t >>> 0) + (r >>> 0), Nh = (n, e, t, r, i) => e + t + r + i + (n / 2 ** 32 | 0) | 0, bh = (n, e, t, r, i) => (n >>> 0) + (e >>> 0) + (t >>> 0) + (r >>> 0) + (i >>> 0), xh = (n, e, t, r, i, o) => e + t + r + i + o + (n / 2 ** 32 | 0) | 0, Bh = {
  fromBig: vf,
  split: rh,
  toBig: ih,
  shrSH: sh,
  ...
  "0x5fcb6fab3ad6faec",
  "0x6c44198c4a475817"
].map((n) => BigInt(n))))(), as = /* @__PURE__ */ new Uint32Array(80), us = /* @__PURE__ */ new Uint32Array(80);
class Oh extends Sf {
  constructor() {
  ...
  // prettier-ignore
  get() {
    const { Ah: e, Al: t, Bh: r, Bl: i, Ch: o, Cl: c, Dh: u, Dl: f, Eh: m, El: h, Fh: g, Fl: y, Gh: b, Gl: O, Hh: A, Hl: M } = this;
    return [e, t, r, i, o, c, u, f, m, h, g, y, b, O, A, M];
  }
  // prettier-ignore
  set(e, t, r, i, o, c, u, f, m, h, g, y, b, O, A, M) {
    this.Ah = e | 0, this.Al = t | 0, this.Bh = r | 0, this.Bl = i | 0, this.Ch = o | 0, this.Cl = c | 0, this.Dh = u | 0, this.Dl = f | 0, this.Eh = m | 0, this.El = h | 0, this.Fh = g | 0, this.Fl = y | 0, this.Gh = b | 0, this.Gl = O | 0, this.Hh = A | 0, this.Hl = M | 0;
  }
  process(e, t) {
    for (let _ = 0; _ < 16; _++, t += 4)
      as[_] = e.getUint32(t), us[_] = e.getUint32(t += 4);
    for (let _ = 16; _ < 80; _++) {
      const re = as[_ - 15] | 0, F = us[_ - 15] | 0, R = fe.rotrSH(re, F, 1) ^ fe.rotrSH(re, F, 8) ^ fe.shrSH(re, F, 7), Q = fe.rotrSL(re, F, 1) ^ fe.rotrSL(re, F, 8) ^ fe.shrSL(re, F, 7), te = as[_ - 2] | 0, ae = us[_ - 2] | 0, Be = fe.rotrSH(te, ae, 19) ^ fe.rotrBH(te, ae, 61) ^ fe.shrSH(te, ae, 6), Oe = fe.rotrSL(te, ae, 19) ^ fe.rotrBL(te, ae, 61) ^ fe.shrSL(te, ae, 6), Le = fe.add4L(Q, Oe, us[_ - 7], us[_ - 16]), Ze = fe.add4H(Le, R, Be, as[_ - 7], as[_ - 16]);
      as[_] = Ze | 0, us[_] = Le | 0;
    }
    let { Ah: r, Al: i, Bh: o, Bl: c, Ch: u, Cl: f, Dh: m, Dl: h, Eh: g, El: y, Fh: b, Fl: O, Gh: A, Gl: M, Hh: W, Hl: me } = this;
    for (let _ = 0; _ < 80; _++) {
      const re = fe.rotrSH(g, y, 14) ^ fe.rotrSH(g, y, 18) ^ fe.rotrBH(g, y, 41), F = fe.rotrSL(g, y, 14) ^ fe.rotrSL(g, y, 18) ^ fe.rotrBL(g, y, 41), R = g & b ^ ~g & A, Q = y & O ^ ~y & M, te = fe.add5L(me, F, Q, Ih[_], us[_]), ae = fe.add5H(te, W, re, R, kh[_], as[_]), Be = te | 0, Oe = fe.rotrSH(r, i, 28) ^ fe.rotrBH(r, i, 34) ^ fe.rotrBH(r, i, 39), Le = fe.rotrSL(r, i, 28) ^ fe.rotrBL(r, i, 34) ^ fe.rotrBL(r, i, 39), Ze = r & o ^ r & u ^ o & u, an = i & c ^ i & f ^ c & f;
      W = A | 0, me = M | 0, A = b | 0, M = O | 0, b = g | 0, O = y | 0, { h: g, l: y } = fe.add(m | 0, h | 0, ae | 0, Be | 0), m = u | 0, h = f | 0, u = o | 0, f = c | 0, o = r | 0, c = i | 0;
      const je = fe.add3L(Be, Le, an);
      r = fe.add3H(je, ae, Oe, Ze), i = je | 0;
    }
    ({ h: r, l: i } = fe.add(this.Ah | 0, this.Al | 0, r | 0, i | 0)), { h: o, l: c } = fe.add(this.Bh | 0, this.Bl | 0, o | 0, c | 0), { h: u, l: f } = fe.add(this.Ch | 0, this.Cl | 0, u | 0, f | 0), { h: m, l: h } = fe.add(this.Dh | 0, this.Dl | 0, m | 0, h | 0), { h: g, l: y } = fe.add(this.Eh | 0, this.El | 0, g | 0, y | 0), { h: b, l: O } = fe.add(this.Fh | 0, this.Fl | 0, b | 0, O | 0), { h: A, l: M } = fe.add(this.Gh | 0, this.Gl | 0, A | 0, M | 0), { h: W, l: me } = fe.add(this.Hh | 0, this.Hl | 0, W | 0, me | 0), this.set(r, i, o, c, u, f, m, h, g, y, b, O, A, M, W, me);
  }
  roundClean() {
    as.fill(0), us.fill(0);
  }
...
const Jf = /* @__PURE__ */ Of(() => new Oh());
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
BigInt(0);
const Sh = BigInt(1), vh = BigInt(2), yu = (n) => n instanceof Uint8Array, Jh = /* @__PURE__ */ Array.from({ length: 256 }, (n, e) => e.toString(16).padStart(2, "0"));
function Ic(n) {
  if (!yu(n))
    throw new Error("Uint8Array expected");
  let e = "";
...
function Ya(n) {
  if (!yu(n))
    throw new Error("Uint8Array expected");
  return Ff(Ic(Uint8Array.from(n).reverse()));
}
function Uf(n, e) {
  return Af(n.toString(16).padStart(e * 2, "0"));
}
function ec(n, e) {
  return Uf(n, e).reverse();
}
function cs(n, e, t) {
  let r;
  if (typeof e == "string")
...
const Ah = (n) => (vh << BigInt(n - 1)) - Sh, Uh = {
...
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
const Ve = BigInt(0), Ae = BigInt(1), Fs = BigInt(2), Lh = BigInt(3), tc = BigInt(4), pl = BigInt(5), gl = BigInt(8);
BigInt(9);
BigInt(16);
function qe(n, e) {
  const t = n % e;
...
function Ch(n) {
  const e = (n - Ae) / Fs;
  let t, r, i;
  for (t = n - Ae, r = 0; t % Fs === Ve; t /= Fs, r++)
    ;
  for (i = Fs; i < n && Dh(i, e, n) !== n - Ae; i++)
    ;
  if (r === 1) {
    const c = (n + Ae) / tc;
    return function(f, m) {
  ...
  return function(u, f) {
    ...
    for (; !u.eql(y, u.ONE); ) {
      ...
      for (let A = u.sqr(y); b < m && !u.eql(A, u.ONE); b++)
        A = u.sqr(A);
      const O = u.pow(h, Ae << BigInt(m - b - 1));
      h = u.sqr(O), g = u.mul(g, O), y = u.mul(y, h), m = b;
    }
    return g;
  };
}
function qh(n) {
  ...
  if (n % gl === pl) {
    const e = (n - pl) / gl;
    return function(r, i) {
      const o = r.mul(i, Fs), c = r.pow(o, e), u = r.mul(i, c), f = r.mul(r.mul(u, Fs), c), m = r.mul(u, r.sub(f, r.ONE));
      if (!r.eql(r.sqr(m), i))
        throw new Error("Cannot find square root");
      return m;
    };
...
function Vh(n, e, t = !1, r = {}) {
  if (n <= Ve)
    throw new Error(`Expected Field ORDER > 0, got ${n}`);
  const { nBitLength: i, nByteLength: o } = Lf(n, e);
  if (o > 2048)
    throw new Error("Field lengths over 2048 bytes are not supported");
  const c = qh(n), u = Object.freeze({
    ORDER: n,
    BITS: i,
    BYTES: o,
    MASK: Ah(i),
    ...
    inv: (f) => wl(f, n),
    sqrt: r.sqrt || ((f) => c(u, f)),
    invertBatch: (f) => Mh(u, f),
    // TODO: do we really need constant cmov?
    // We don't have const-time bigints anyway, so probably will be not very useful
    cmov: (f, m, h) => h ? m : f,
    toBytes: (f) => t ? ec(f, o) : Uf(f, o),
    fromBytes: (f) => {
      if (f.length !== o)
...
function zh(n, e) {
  ...
  return {
    ...
    unsafeLadder(i, o) {
      let c = n.ZERO, u = i;
      for (; o > jh; )
        o & Ku && (c = c.add(u)), u = u.double(), o >>= Ku;
      return c;
    },
    /**
    ...
    wNAF(i, o, c) {
      ...
      for (let O = 0; O < u; O++) {
        ...
        let M = Number(c & g);
        c >>= b, M > f && (M -= y, c += Ku);
        const W = A, me = A + Math.abs(M) - 1, _ = O % 2 !== 0, re = M < 0;
        M === 0 ? h = h.add(t(_, o[W])) : m = m.add(t(re, o[me]));
      }
      return { p: m, f: h };
    },
    wNAFCached(i, o, c, u) {
...
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
const wt = BigInt(0), ot = BigInt(1), Pa = BigInt(2), Rh = BigInt(8), Yh = { zip215: !0 };
function Xh(n) {
  const e = Wh(n);
  return Oc(n, {
    hash: "function",
...
function Sc(n) {
  const e = Xh(n), { Fp: t, n: r, prehash: i, hash: o, randomBytes: c, nByteLength: u, h: f } = e, m = Pa << BigInt(u * 8) - ot, h = t.create, g = e.uvRatio || ((K, q) => {
    try {
      return { isValid: !0, value: t.sqrt(K * t.inv(q)) };
    } catch {
      return { isValid: !1, value: wt };
    }
  }), y = e.adjustScalarBytes || ((K) => K), b = e.domain || ((K, q, Y) => {
    if (q.length || Y)
      throw new Error("Contexts/pre-hash are not supported");
    return K;
  }), O = (K) => typeof K == "bigint" && wt < K, A = (K, q) => O(K) && O(q) && K < q, M = (K) => K === wt || A(K, m);
  function W(K, q) {
    if (A(K, q))
      return K;
    throw new Error(`Expected valid scalar < ${q}, got ${typeof K} ${K}`);
  }
  function me(K) {
    return K === wt ? K : W(K, r);
  }
  ...
  class F {
    constructor(q, Y, z, X) {
      if (this.ex = q, this.ey = Y, this.ez = z, this.et = X, !M(q))
    ...
    static fromAffine(q) {
      ...
      return new F(Y, z, ot, h(Y * z));
    }
    static normalizeZ(q) {
      const Y = t.invertBatch(q.map((z) => z.ez));
      return q.map((z, X) => z.toAffine(Y[X])).map(F.fromAffine);
    }
    // "Private method", don't use it directly
    _setWindowSize(q) {
      this._WINDOW_SIZE = q, _.delete(this);
    }
    ...
    assertValidity() {
      ...
      const { ex: z, ey: X, ez: ue, et: ge } = this, be = h(z * z), we = h(X * X), pe = h(ue * ue), Ne = h(pe * pe), ve = h(be * q), De = h(pe * h(ve + we)), Ce = h(Ne + h(Y * h(be * we)));
      if (De !== Ce)
        throw new Error("bad point: equation left != right (1)");
      const Re = h(z * X), w = h(ue * ge);
      if (Re !== w)
    ...
    equals(q) {
      re(q);
      const { ex: Y, ey: z, ez: X } = this, { ex: ue, ey: ge, ez: be } = q, we = h(Y * be), pe = h(ue * X), Ne = h(z * be), ve = h(ge * X);
      return we === pe && Ne === ve;
    }
    is0() {
    ...
    double() {
      const { a: q } = e, { ex: Y, ey: z, ez: X } = this, ue = h(Y * Y), ge = h(z * z), be = h(Pa * h(X * X)), we = h(q * ue), pe = Y + z, Ne = h(h(pe * pe) - ue - ge), ve = we + ge, De = ve - be, Ce = we - ge, Re = h(Ne * De), w = h(ve * Ce), E = h(Ne * Ce), B = h(De * ve);
    ...
    add(q) {
      re(q);
      const { a: Y, d: z } = e, { ex: X, ey: ue, ez: ge, et: be } = this, { ex: we, ey: pe, ez: Ne, et: ve } = q;
      if (Y === BigInt(-1)) {
        const I = h((ue - X) * (pe + we)), j = h((ue + X) * (pe - we)), V = h(j - I);
        if (V === wt)
          return this.double();
        const H = h(ge * Pa * ve), Z = h(be * Pa * Ne), d = Z + H, a = j + I, l = Z - H, p = h(d * V), T = h(a * l), x = h(d * l), k = h(V * a);
        return new F(p, T, k, x);
      }
      const De = h(X * we), Ce = h(ue * pe), Re = h(be * z * ve), w = h(ge * Ne), E = h((X + ue) * (we + pe) - De - Ce), B = w - Re, J = w + Re, S = h(Ce - Y * De), D = h(E * B), $ = h(J * S), U = h(E * S), C = h(B * J);
      return new F(D, $, C, U);
    }
    subtract(q) {
    ...
    wNAF(q) {
      return te.wNAFCached(this, _, q, F.normalizeZ);
    }
    // Constant-time multiplication.
    multiply(q) {
      const { p: Y, f: z } = this.wNAF(W(q, r));
    ...
    multiplyUnsafe(q) {
      let Y = me(q);
      return Y === wt ? Q : this.equals(Q) || Y === ot ? this : this.equals(R) ? this.wNAF(Y).p : te.unsafeLadder(this, Y);
    }
    ...
    toAffine(q) {
      const { ex: Y, ey: z, ez: X } = this, ue = this.is0();
      q == null && (q = ue ? Rh : t.inv(X));
      const ge = h(Y * q), be = h(z * q), we = h(X * q);
      if (ue)
        return { x: wt, y: ot };
      if (we !== ot)
    ...
    toRawBytes() {
      const { x: q, y: Y } = this.toAffine(), z = ec(Y, t.BYTES);
      return z[z.length - 1] |= q & ot ? 128 : 0, z;
    }
    toHex() {
      return Ic(this.toRawBytes());
    }
  }
  F.BASE = new F(e.Gx, e.Gy, ot, h(e.Gx * e.Gy)), F.ZERO = new F(wt, ot, ot, wt);
  const { BASE: R, ZERO: Q } = F, te = zh(F, u * 8);
  function ae(K) {
    return qe(K, r);
  }
  function Be(K) {
  ...
  function Oe(K) {
    const q = u;
    K = cs("private key", K, q);
    const Y = cs("hashed private key", o(K), 2 * q), z = y(Y.slice(0, q)), X = Y.slice(q, 2 * q), ue = Be(z), ge = R.multiply(ue), be = ge.toRawBytes();
    return { head: z, prefix: X, scalar: ue, point: ge, pointBytes: be };
  }
  function Le(K) {
    return Oe(K).pointBytes;
  }
  function Ze(K = new Uint8Array(), ...q) {
    const Y = hl(...q);
    return Be(o(b(Y, cs("context", K), !!i)));
  }
  function an(K, q, Y = {}) {
    K = cs("message", K), i && (K = i(K));
    const { prefix: z, scalar: X, pointBytes: ue } = Oe(q), ge = Ze(Y.context, z, K), be = R.multiply(ge).toRawBytes(), we = Ze(Y.context, be, ue, K), pe = ae(ge + we * X);
    me(pe);
    const Ne = hl(be, ec(pe, t.BYTES));
    return cs("result", Ne, u * 2);
  }
  const je = Yh;
  function $e(K, q, Y, z = je) {
    const { context: X, zip215: ue } = z, ge = t.BYTES;
    K = cs("signature", K, 2 * ge), q = cs("message", q), i && (q = i(q));
    const be = Ya(K.slice(ge, 2 * ge));
    let we, pe, Ne;
    try {
      we = F.fromHex(Y, ue), pe = F.fromHex(K.slice(0, ge), ue), Ne = R.multiplyUnsafe(be);
    } catch {
      return !1;
    }
  ...
  return R._setWindowSize(8), {
    ...
    utils: {
       ...
       */
      precompute(K = 8, q = F.BASE) {
        return q._setWindowSize(K), q.multiply(BigInt(3)), q;
      }
    }
  };
}
...
BigInt(0);
const Zh = BigInt(1), nc = BigInt(2), Gh = BigInt(5), Tl = BigInt(10), Qh = BigInt(20), ep = BigInt(40), El = BigInt(80);
function tp(n) {
  const e = vc, r = n * n % e * n % e, i = Ft(r, nc, e) * r % e, o = Ft(i, Zh, e) * n % e, c = Ft(o, Gh, e) * o % e, u = Ft(c, Tl, e) * c % e, f = Ft(u, Qh, e) * u % e, m = Ft(f, ep, e) * f % e, h = Ft(m, El, e) * m % e, g = Ft(h, El, e) * m % e, y = Ft(g, Tl, e) * c % e;
  return { pow_p_5_8: Ft(y, nc, e) * n % e, b2: r };
}
function np(n) {
  return n[0] &= 248, n[31] &= 127, n[31] |= 64, n;
}
function rp(n, e) {
  const t = vc, r = qe(e * e * e, t), i = qe(r * r * e, t), o = tp(n * i).pow_p_5_8;
  let c = qe(n * r * o, t);
  const u = qe(e * c * c, t), f = c, m = qe(c * yl, t), h = u === n, g = u === qe(-n, t), y = u === qe(-n * yl, t);
  return h && (c = f), (g || y) && (c = m), Ph(c, t) && (c = qe(-c, t)), { isValid: h || g, value: c };
}
const rs = Vh(vc, void 0, !0), Jc = {
  // Param: a
  a: BigInt(-1),
...
function Df(n, e, t) {
  ...
  return Qd(kf("SigEd25519 no Ed25519 collisions"), new Uint8Array([t ? 1 : 0, e.length]), e, n);
}
({
  ...Jc
});
...
const ip = (rs.ORDER + BigInt(3)) / BigInt(8);
rs.pow(nc, ip);
rs.sqrt(rs.neg(rs.ONE));
(rs.ORDER - BigInt(5)) / BigInt(8);
BigInt(486662);
Hh(rs, rs.neg(BigInt(486664)));
BigInt("25063068953384623474111414158702152701244531502492656460079210482610430750235");
BigInt("54469307008909316920995813868745141605393597292927456921205312896311721017578");
BigInt("1159843021668779879193775521855586647937357759715417654439879720876111806838");
BigInt("40440834346308536858101042469323190826248399146238708352240133220865137265952");
BigInt("0x7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
const Cf = () => new Error("invalid size"), qf = () => new Error("destination is required"), Pf = () => new Error("amount is required"), Kf = () => new Error("currency is required"), Ws = () => new Error("invalid currency"), Na = () => new Error("unexpected error"), sp = () => new Error("cannot derive nonce from both clientSecret and idempotencyKey"), _f = () => new Error("invalid value"), $f = () => new Error("invalid mode"), _u = () => new Error("invalid address"), Fc = () => new Error("login is required"), ba = () => new Error("login verifier is required"), Ac = () => new Error("login domain is required"), op = () => new Error("invalid login domain"), ap = () => new Error("login subdomains are not supported"), up = () => new Error("login IP addresses are not supported"), cp = () => new Error("login localhost is not supported"), lp = () => new Error("login ports are not supported"), Nl = () => new Error("login expected domain name but received a path"), bl = 32, fp = /^[123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz]+$/;
class gt {
  /**
   ...
   */
  verify(e, t) {
    return vs.verify(t, new Uint8Array(e), this.value);
  }
}
class fn {
  /**
   ...
   */
  static generate() {
    const e = vs.utils.randomPrivateKey(), t = vs.getPublicKey(e);
    return new fn(e, t);
  }
  /**
  ...
  static fromSecretKey(e) {
    const t = e.subarray(0, 32), r = vs.getPublicKey(t);
    return new fn(t, r);
  }
  /**
   ...
   */
  sign(e) {
    return vs.sign(new Uint8Array(e), this.privateKey);
  }
  /**
   ...
   */
  verify(e, t) {
    return vs.verify(t, new Uint8Array(e), this.publicKey);
  }
  /**
...
class Qs {
   ...
   */
  constructor(e) {
    if (this.kind = e.kind, this.amount = e.amount, this.nonce = e.nonce, e.currency && !Mf(e.currency))
      throw Ws();
   ...
   */
  static fromData(e) {
    if (e.length !== Qs.MAX_LENGTH)
      throw Cf();
    const t = e[0];
    let r, i, o;
    if (t === Qe.RequestPayment) {
      const c = e[1];
      o = dp(c), r = e.slice(2, 9).reduce((u, f, m) => u + (BigInt(f) << BigInt(8 * m)), BigInt(0));
    }
    return (t === Qe.Cash || t === Qe.GiftCard) && (r = e.slice(1, 9).reduce((c, u, f) => c + (BigInt(u) << BigInt(8 * f)), BigInt(0))), i = e.slice(9), new Qs({ kind: t, amount: r, currency: o, nonce: i });
  }
}
Qs.MAX_LENGTH = 20;
function hp(n) {
...
function Uc(n) {
  switch (hp(n), n.mode) {
    case "login":
      ...
      break;
    case "payment":
      pp(n), n.login && xl(n), n.signers && Bl(n);
      break;
    default:
      throw $f();
  }
...
Ee.mint = gt.fromBase58(Ee.mintAddress);
Ee.zero = new Ee(0, 0);
Ee.one = new Ee(1, 0);
Ee.max = new Ee(Number.MAX_SAFE_INTEGER, Number(Ee.quarksPerKin - 1n));
Ee.min = new Ee(Number.MIN_SAFE_INTEGER, 0);
const gp = (n, e, t) => n & e ^ ~n & t, wp = (n, e, t) => n & e ^ n & t ^ e & t, yp = /* @__PURE__ */ new Uint32Array([
  1116352408,
  1899447441,
  3049323471,
  3921009573,
...
class Tp extends Sf {
  ...
  process(e, t) {
    for (let g = 0; g < 16; g++, t += 4)
      fs[g] = e.getUint32(t, !1);
    for (let g = 16; g < 64; g++) {
      const y = fs[g - 15], b = fs[g - 2], O = Jt(y, 7) ^ Jt(y, 18) ^ y >>> 3, A = Jt(b, 17) ^ Jt(b, 19) ^ b >>> 10;
      fs[g] = A + fs[g - 7] + O + fs[g - 16] | 0;
    }
    let { A: r, B: i, C: o, D: c, E: u, F: f, G: m, H: h } = this;
    for (let g = 0; g < 64; g++) {
      const y = Jt(u, 6) ^ Jt(u, 11) ^ Jt(u, 25), b = h + y + gp(u, f, m) + yp[g] + fs[g] | 0, A = (Jt(r, 2) ^ Jt(r, 13) ^ Jt(r, 22)) + wp(r, i, o) | 0;
...
class mt {
   ...
   */
  static fromSeed(e) {
    return new mt(Vf(e).subarray(0, mt.MAX_LENGTH));
  }
  /**
   ...
   */
  static generate() {
    const e = fn.generate().getPrivateValue().subarray(0, mt.MAX_LENGTH);
    return new mt(e);
  }
  /**
...
mt.MAX_LENGTH = 11;
function Ep(n) {
  return fn.fromSeed(Vf(n.toBinary()));
}
class Hf {
  /**
  ...
  constructor(e) {
    this.options = {
      ...e
    }, this.init(), this.validate(), this.options.idempotencyKey ? this.nonce = mt.fromSeed(this.options.idempotencyKey) : this.options.clientSecret ? this.nonce = mt.fromClientSecret(this.options.clientSecret) : this.nonce = mt.generate(), this.rendezvousPayload = this.toPayload(), this.rendezvousKeypair = Ep(this.rendezvousPayload);
  }
  /**
...
class Lc extends Hf {
  ...
  toPayload() {
    ...
    return new Qs({ kind: e, amount: t, nonce: r, currency: this.options.currency });
  }
  /**
...
class Np extends Lc {
  ...
  constructor(e) {
    ...
    this.domain = r, this.verifier = gt.fromBase58(i), t && (this.signer = t.find((o) => o.getPublicKey().toBase58() === i));
  }
  /**
   * Validates the payment request options.
   */
...
function Fa(n) {
  return encodeURIComponent(xp(JSON.stringify(n ?? {})));
}
function ks(n, e) {
...
const xe = Object.freeze({}), Rs = Object.freeze([]), st = () => {
}, jf = () => !1, Bp = /^on[^a-z]/, Aa = (n) => Bp.test(n), su = (n) => n.startsWith("onUpdate:"), Se = Object.assign, Dc = (n, e) => {
  const t = n.indexOf(e);
  t > -1 && n.splice(t, 1);
}, kp = Object.prototype.hasOwnProperty, de = (n, e) => kp.call(n, e), ee = Array.isArray, Ys = (n) => Tu(n) === "[object Map]", Ip = (n) => Tu(n) === "[object Set]", se = (n) => typeof n == "function", Ue = (n) => typeof n == "string", Cc = (n) => typeof n == "symbol", Ie = (n) => n !== null && typeof n == "object", qc = (n) => Ie(n) && se(n.then) && se(n.catch), Op = Object.prototype.toString, Tu = (n) => Op.call(n), Pc = (n) => Tu(n).slice(8, -1), Sp = (n) => Tu(n) === "[object Object]", Kc = (n) => Ue(n) && n !== "NaN" && n[0] !== "-" && "" + parseInt(n, 10) === n, Xa = /* @__PURE__ */ ks(
...
}, Jp = /-(\w)/g, eo = Eu((n) => n.replace(Jp, (e, t) => t ? t.toUpperCase() : "")), Fp = /\B([A-Z])/g, Ns = Eu(
  (n) => n.replace(Fp, "-$1").toLowerCase()
), Nu = Eu(
  (n) => n.charAt(0).toUpperCase() + n.slice(1)
), Js = Eu(
  (n) => n ? `on${Nu(n)}` : ""
), xa = (n, e) => !Object.is(n, e), oo = (n, e) => {
  for (let t = 0; t < n.length; t++)
    n[t](e);
}, ou = (n, e, t) => {
...
let kl;
const au = () => kl || (kl = typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : typeof window < "u" ? window : typeof {} < "u" ? {} : {});
function Is(n) {
  if (ee(n)) {
    const e = {};
    for (let t = 0; t < n.length; t++) {
      const r = n[t], i = Ue(r) ? Cp(r) : Is(r);
      if (i)
        for (const o in i)
          e[o] = i[o];
    }
...
function Cp(n) {
  const e = {};
  return n.replace(Dp, "").split(Up).forEach((t) => {
    if (t) {
      const r = t.split(Lp);
...
const $c = (n) => {
...
}, Wf = (n) => (n.w & bs) > 0, Rf = (n) => (n.n & bs) > 0, zp = ({ deps: n }) => {
  if (n.length)
  ...
  if (e.length) {
    ...
    for (let r = 0; r < e.length; r++) {
      const i = e[r];
      Wf(i) && !Rf(i) ? i.delete(n) : e[t++] = i, i.w &= ~bs, i.n &= ~bs;
    }
    e.length = t;
  }
...
const sc = 30;
let Xe;
const Us = Symbol("iterate"), oc = Symbol("Map key iterate");
class Mc {
  constructor(e, t = null, r) {
    this.fn = e, this.scheduler = t, this.active = !0, this.deps = [], this.parent = void 0, Hp(this, r);
  }
  run() {
    if (!this.active)
      return this.fn();
    ...
    try {
      return this.parent = Xe, Xe = this, ys = !0, bs = 1 << ++mo, mo <= sc ? zp(this) : Il(this), this.fn();
    } finally {
      mo <= sc && Wp(this), bs = 1 << --mo, Xe = this.parent, ys = t, this.parent = void 0, this.deferStop && this.stop();
    }
  }
  stop() {
    Xe === this ? this.deferStop = !0 : this.active && (Il(this), this.onStop && this.onStop(), this.active = !1);
  }
}
function Il(n) {
  const { deps: e } = n;
...
function We(n, e, t) {
  if (ys && Xe) {
    ...
    let i = r.get(t);
    i || r.set(t, i = $c()), Xf(i, { effect: Xe, target: n, type: e, key: t });
  }
}
function Xf(n, e) {
  let t = !1;
  mo <= sc ? Rf(n) || (n.n |= bs, t = !Wf(n)) : t = !n.has(Xe), t && (n.add(Xe), Xe.deps.push(n), Xe.onTrack && Xe.onTrack(
    Se(
      {
        effect: Xe
      },
...
function on(n, e, t, r, i, o) {
  ...
  if (e === "clear")
    ...
    switch (t !== void 0 && u.push(c.get(t)), e) {
      case "add":
        ee(n) ? Kc(t) && u.push(c.get("length")) : (u.push(c.get(Us)), Ys(n) && u.push(c.get(oc)));
        break;
      case "delete":
        ee(n) || (u.push(c.get(Us)), Ys(n) && u.push(c.get(oc)));
        break;
      case "set":
        Ys(n) && u.push(c.get(Us));
        break;
    }
...
const Rp = /* @__PURE__ */ ks("__proto__,__v_isRef,__isVue"), Zf = new Set(
  /* @__PURE__ */ Object.getOwnPropertyNames(Symbol).filter((n) => n !== "arguments" && n !== "caller").map((n) => Symbol[n]).filter(Cc)
), Yp = /* @__PURE__ */ bu(), Xp = /* @__PURE__ */ bu(!1, !0), Zp = /* @__PURE__ */ bu(!0), Gp = /* @__PURE__ */ bu(!0, !0), Sl = /* @__PURE__ */ Qp();
function Qp() {
  const n = {};
...
function bu(n = !1, e = !1) {
  return function(r, i, o) {
    ...
    if (i === "__v_isShallow")
      return e;
    if (i === "__v_raw" && o === (n ? e ? sm : im : e ? rm : nm).get(r))
      return r;
    const c = ee(r);
    if (!n) {
      if (c && de(Sl, i))
        return Reflect.get(Sl, i, o);
      if (i === "hasOwnProperty")
        return eg;
    }
    const u = Reflect.get(r, i, o);
    return (Cc(i) ? Zf.has(i) : Rp(i)) || (n || We(r, "get", i), e) ? u : _e(u) ? c && Kc(i) ? u : u.value : Ie(u) ? n ? om(u) : ku(u) : u;
  };
}
const tg = /* @__PURE__ */ Gf(), ng = /* @__PURE__ */ Gf(!0);
function Gf(n = !1) {
  return function(t, r, i, o) {
    let c = t[r];
    if (xs(c) && _e(c) && !_e(i))
      return !1;
    if (!n && (!uu(i) && !xs(i) && (c = ce(c), i = ce(i)), !ee(t) && _e(c) && !_e(i)))
      return c.value = i, !0;
    const u = ee(t) && Kc(r) ? Number(r) < t.length : de(t, r), f = Reflect.set(t, r, i, o);
    return t === ce(o) && (u ? xa(i, c) && on(t, "set", r, i, c) : on(t, "add", r, i)), f;
  };
}
function rg(n, e) {
  const t = de(n, e), r = n[e], i = Reflect.deleteProperty(n, e);
  return i && t && on(n, "delete", e, void 0, r), i;
}
function ig(n, e) {
  const t = Reflect.has(n, e);
  return (!Cc(e) || !Zf.has(e)) && We(n, "has", e), t;
}
function sg(n) {
  return We(n, "iterate", ee(n) ? "length" : Us), Reflect.ownKeys(n);
}
const Qf = {
  get: Yp,
  set: tg,
...
function $a(n, e = !1) {
  return n = n.__v_raw, !e && We(ce(n), "iterate", Us), Reflect.get(n, "size", n);
}
function vl(n) {
  n = ce(n);
  const e = ce(this);
  return xu(e).has.call(e, n) || (e.add(n), on(e, "add", n, n)), this;
}
function Jl(n, e) {
  e = ce(e);
  const t = ce(this), { has: r, get: i } = xu(t);
  let o = r.call(t, n);
  o ? tm(t, r, n) : (n = ce(n), o = r.call(t, n));
  const c = i.call(t, n);
  return t.set(n, e), o ? xa(e, c) && on(t, "set", n, e, c) : on(t, "add", n, e), this;
}
function Fl(n) {
  const e = ce(this), { has: t, get: r } = xu(e);
  let i = t.call(e, n);
  i ? tm(e, t, n) : (n = ce(n), i = t.call(e, n));
  const o = r ? r.call(e, n) : void 0, c = e.delete(n);
  return i && on(e, "delete", n, void 0, o), c;
}
function Al() {
  const n = ce(this), e = n.size !== 0, t = Ys(n) ? new Map(n) : new Set(n), r = n.clear();
  return e && on(n, "clear", void 0, void 0, t), r;
}
function Ma(n, e) {
  return function(r, i) {
    const o = this, c = o.__v_raw, u = ce(c), f = e ? Vc : n ? Hc : Ba;
    return !n && We(u, "iterate", Us), c.forEach((m, h) => r.call(i, f(m), f(h), o));
  };
}
function Va(n, e, t) {
  return function(...r) {
...
function yg(n) {
  return n.__v_skip || !Object.isExtensible(n) ? 0 : wg(Pc(n));
}
function ku(n) {
  return xs(n) ? n : Iu(
    n,
...
function Ls(n) {
  return xs(n) ? Ls(n.__v_raw) : !!(n && n.__v_isReactive);
}
function xs(n) {
...
const Ba = (n) => Ie(n) ? ku(n) : n, Hc = (n) => Ie(n) ? om(n) : n;
function um(n) {
  ys && Xe && (n = ce(n), Xf(n.dep || (n.dep = $c()), {
    target: n,
    type: "get",
    key: "value"
  }));
...
class Ng {
  ...
  get value() {
    return um(this), this._value;
  }
  set value(e) {
    const t = this.__v_isShallow || uu(e) || xs(e);
    e = t ? e : ce(e), xa(e, this._rawValue) && (this._rawValue = e, this._value = t ? e : Ba(e), cm(this, e));
  }
}
function ds(n) {
  return _e(n) ? n.value : n;
}
const bg = {
  get: (n, e, t) => ds(Reflect.get(n, e, t)),
  set: (n, e, t, r) => {
    const i = n[e];
    return _e(i) && !_e(t) ? (i.value = t, !0) : Reflect.set(n, e, t, r);
  }
};
function lm(n) {
  return Ls(n) ? n : new Proxy(n, bg);
}
class xg {
  constructor(e, t, r, i) {
    this._setter = t, this.dep = void 0, this.__v_isRef = !0, this.__v_isReadonly = !1, this._dirty = !0, this.effect = new Mc(e, () => {
      this._dirty || (this._dirty = !0, cm(this));
    }), this.effect.computed = this, this.effect.active = this._cacheable = !i, this.__v_isReadonly = r;
  }
  get value() {
    const e = ce(this);
    return um(e), (e._dirty || !e._cacheable) && (e._dirty = !1, e._value = e.effect.run()), e._value;
  }
  set value(e) {
    this._setter(e);
  }
...
function P(n, ...e) {
  Ks();
  const t = Ds.length ? Ds[Ds.length - 1].component : null, r = t && t.appContext.config.warnHandler, i = kg();
  if (r)
    is(
      r,
      t,
...
function fm(n, e, t) {
  return Ue(e) ? (e = JSON.stringify(e), t ? e : [`${n}=${e}`]) : typeof e == "number" || typeof e == "boolean" || e == null ? t ? e : [`${n}=${e}`] : _e(e) ? (e = fm(n, ce(e.value), !0), t ? e : [`${n}=Ref<`, e, ">"]) : se(e) ? [`${n}=fn${e.name ? `<${e.name}>` : ""}`] : (e = ce(e), t ? e : [`${n}=`, e]);
}
const jc = {
...
function vg(n, e, t, r = !0) {
  {
    const i = jc[e];
    if (t && Za(t), P(`Unhandled error${i ? ` during execution of ${i}` : ""}`), t && Ga(), r)
      throw n;
    console.error(n);
  }
}
...
function Su(n) {
  (!ze.length || !ze.includes(
    n,
    ka && n.allowRecurse ? Dt + 1 : Dt
  )) && (n.id == null ? ze.push(n) : ze.splice(Fg(n.id), 0, n), dm());
}
function dm() {
  !ka && !cc && (cc = !0, zc = mm.then(gm));
}
function Ag(n) {
...
function hm(n) {
  ee(n) ? Xs.push(...n) : (!Ut || !Ut.includes(
    n,
    n.allowRecurse ? hs + 1 : hs
  )) && Xs.push(n), dm();
}
function Ul(n, e = ka ? Dt + 1 : 0) {
...
function pm(n) {
  if (Xs.length) {
    ...
    for (Ut = e, n = n || /* @__PURE__ */ new Map(), Ut.sort((t, r) => Ia(t) - Ia(r)), hs = 0; hs < Ut.length; hs++)
      Wc(n, Ut[hs]) || Ut[hs]();
    Ut = null, hs = 0;
  }
}
const Ia = (n) => n.id == null ? 1 / 0 : n.id, Ug = (n, e) => {
  const t = Ia(n) - Ia(e);
  if (t === 0) {
    if (n.pre && !e.pre)
      return -1;
...
function gm(n) {
  cc = !1, ka = !0, n = n || /* @__PURE__ */ new Map(), ze.sort(Ug);
  const e = (t) => Wc(n, t);
  try {
    for (Dt = 0; Dt < ze.length; Dt++) {
      const t = ze[Dt];
      if (t && t.active !== !1) {
        if (e(t))
          continue;
    ...
    Dt = 0, ze.length = 0, pm(n), ka = !1, zc = null, (ze.length || Xs.length) && gm(n);
  }
}
function Wc(n, e) {
  if (!n.has(e))
    ...
    const t = n.get(e);
    if (t > Jg) {
      const r = e.ownerInstance, i = r && jm(r.type);
      return P(
...
function Lg(n) {
  ...
  let t = Ps.get(e);
  t || (wm(e, n.type), t = Ps.get(e)), t.instances.add(n);
}
function Dg(n) {
  Ps.get(n.type.__hmrId).instances.delete(n);
}
function wm(n, e) {
  return Ps.has(n) ? !1 : (Ps.set(n, {
    initialDef: To(e),
...
function Cg(n, e) {
  ...
  t && (t.initialDef.render = e, [...t.instances].forEach((r) => {
    e && (r.render = e, To(r.type).render = e), r.renderCache = [], Ts = !0, r.update(), Ts = !1;
  }));
}
function qg(n, e) {
  const t = Ps.get(n);
  if (!t)
    return;
  e = To(e), Ll(t.initialDef, e);
  const r = [...t.instances];
  for (const i of r) {
    const o = To(i.type);
    Hs.has(o) || (o !== t.initialDef && Ll(o, e), Hs.add(o)), i.appContext.propsCache.delete(i.type), i.appContext.emitsCache.delete(i.type), i.appContext.optionsCache.delete(i.type), i.ceReload ? (Hs.add(o), i.ceReload(e.styles), Hs.delete(o)) : i.parent ? Su(i.parent.update) : i.appContext.reload ? i.appContext.reload() : typeof window < "u" ? window.location.reload() : console.warn(
...
let Ct, po = [], fc = !1;
function Ua(n, ...e) {
  Ct ? Ct.emit(n, ...e) : fc || po.push({ event: n, args: e });
}
function ym(n, e) {
  var t, r;
  Ct = n, Ct ? (Ct.enabled = !0, po.forEach(({ event: i, args: o }) => Ct.emit(i, ...o)), po = []) : /* handle late devtools injection - only do this if we are in an actual */ /* browser environment to avoid the timer handle stalling test runner exit */ /* (#4815) */ typeof window < "u" && // some envs mock window but not fully
  ...
  !((r = (t = window.navigator) == null ? void 0 : t.userAgent) != null && r.includes("jsdom")) ? ((e.__VUE_DEVTOOLS_HOOK_REPLAY__ = e.__VUE_DEVTOOLS_HOOK_REPLAY__ || []).push((o) => {
    ...
    Ct || (e.__VUE_DEVTOOLS_HOOK_REPLAY__ = null, fc = !0, po = []);
  }, 3e3)) : (fc = !0, po = []);
}
function Pg(n, e) {
  Ua("app:init", n, e, {
...
function zg(n, e, ...t) {
  ...
  const r = n.vnode.props || xe;
  {
    ...
    if (h)
      if (!(e in h))
        (!g || !(Js(e) in g)) && P(
          `Component emitted event "${e}" but it is neither declared in the emits option nor as an "${Js(e)}" prop.`
        );
      else {
        const y = h[e];
        se(y) && (y(...t) || P(
  ...
  if (c && c in r) {
    ...
    y && (i = t.map((b) => Ue(b) ? b.trim() : b)), g && (i = t.map(Ap));
  }
  jg(n, e, i);
  {
    ...
    h !== e && r[Js(h)] && P(
      `Event "${h}" is emitted in component ${Uu(
        n,
        n.type
      )} but the handler is registered for "${e}". Note that HTML attributes are case-insensitive and you cannot use v-on to listen to camelCase events when using in-DOM templates. You should probably use "${Ns(e)}" instead of "${e}".`
    );
  }
  let u, f = r[u = Js(e)] || // also try camelCase event handler (#2249)
  r[u = Js(eo(e))];
  !f && o && (f = r[u = Js(Ns(e))]), f && St(
    f,
    n,
    6,
    i
...
function Nm(n, e, t = !1) {
  ...
  return !o && !u ? (Ie(n) && r.set(n, null), null) : (ee(o) ? o.forEach((f) => c[f] = null) : Se(c, o), Ie(n) && r.set(n, c), c);
}
function vu(n, e) {
  return !n || !Aa(e) ? !1 : (e = e.slice(2).replace(/Once$/, ""), de(n, e[0].toLowerCase() + e.slice(1)) || de(n, Ns(e)) || de(n, e));
}
let pt = null, bm = null;
function cu(n) {
  const e = pt;
  return pt = n, bm = n && n.type.__scopeId || null, e;
}
function Wg(n, e = pt, t) {
  if (!e || n._n)
    return n;
  const r = (...i) => {
    r._d && Wl(-1);
...
function Mu(n) {
  ...
  try {
    ...
    Eo.length = 0, Ou(F, n, 1), M = rn(ct);
  }
  let _ = M, re;
  if (M.patchFlag > 0 && M.patchFlag & 2048 && ([_, re] = Rg(M)), W && A !== !1) {
    ...
    if (F.length) {
      ...
      else if (!mc && _.type !== ct) {
        const Q = Object.keys(f), te = [], ae = [];
        for (let Be = 0, Oe = Q.length; Be < Oe; Be++) {
          const Le = Q[Be];
  ...
  return t.dirs && (Dl(_) || P(
    "Runtime directive used on component with non-element root node. The directives will not function as intended."
  ), _ = Bs(_), _.dirs = _.dirs ? _.dirs.concat(t.dirs) : t.dirs), t.transition && (Dl(_) || P(
    "Component inside <Transition> renders non-element root node that cannot be animated."
  ), _.transition = t.transition), re ? re(_) : M = _, cu(me), M;
}
const Rg = (n) => {
  const e = n.children, t = n.dynamicChildren, r = xm(e);
  if (!r)
    return [n, void 0];
...
function Zg(n, e, t) {
  ...
  if (t && f >= 0) {
    ...
    return (i || u) && (!u || !u.$stable) ? !0 : r === c ? !1 : r ? c ? Cl(r, c, m) : !0 : !!c;
  return !1;
}
function Cl(n, e, t) {
...
function Gg({ vnode: n, parent: e }, t) {
  for (; e && e.subTree === n; )
    (n = e.vnode).el = t, e = e.parent;
}
const Qg = (n) => n.__isSuspense;
function e0(n, e) {
  e && e.pendingBranch ? ee(n) ? e.effects.push(...n) : e.effects.push(n) : hm(n);
}
function Bm(n, e) {
  return Yc(n, null, e);
}
...
function Yc(n, e, { immediate: t, deep: r, flush: i, onTrack: o, onTrigger: c } = xe) {
  var u;
  e || (t !== void 0 && P(
  ...
  }, m = jp() === ((u = He) == null ? void 0 : u.scope) ? He : null;
  let h, g = !1, y = !1;
  if (_e(n) ? (h = () => n.value, g = uu(n)) : Ls(n) ? (h = () => n, r = !0) : ee(n) ? (y = !0, g = n.some((F) => Ls(F) || uu(F)), h = () => n.map((F) => {
    if (_e(F))
      return F.value;
    if (Ls(F))
      return zs(F);
  ...
  const _ = new Mc(h, me);
  _.onTrack = o, _.onTrigger = c, e ? t ? W() : M = _.run() : i === "post" ? Ge(
    _.run.bind(_),
    m && m.suspense
  ) : _.run();
  const re = () => {
    _.stop(), m && m.scope && Dc(m.scope.effects, _);
  };
  return A && A.push(re), re;
}
function t0(n, e, t) {
  const r = this.proxy, i = Ue(n) ? n.includes(".") ? km(r, n) : () => r[n] : n.bind(r, r);
  let o;
  se(e) ? o = e : (o = e.handler, t = e);
  const c = He;
  to(this);
  const u = Yc(i, o.bind(r), t);
  return c ? to(c) : qs(), u;
}
function km(n, e) {
  const t = e.split(".");
...
function zs(n, e) {
  if (!Ie(n) || n.__v_skip || (e = e || /* @__PURE__ */ new Set(), e.has(n)))
    return n;
  if (e.add(n), _e(n))
    zs(n.value, e);
  else if (ee(n))
...
function Im(n) {
  vp(n) && P("Do not use built-in directive ids as custom directive id: " + n);
}
function Os(n, e, t, r) {
...
function Om(n, e, t = He) {
  ...
  if (Ju(e, r, t), t) {
    let i = t.parent;
    for (; i && i.parent; )
      Xc(i.parent.vnode) && i0(r, e, t, i), i = i.parent;
  }
}
function i0(n, e, t, r) {
  const i = Ju(
...
), s0 = ss("bm"), Fu = ss("m"), o0 = ss("bu"), a0 = ss("u"), u0 = ss("bum"), Sm = ss("um"), c0 = ss("sp"), l0 = ss(
  "rtg"
), f0 = ss(
  "rtc"
);
...
const d0 = Symbol.for("v-ndc"), dc = (n) => n ? Vm(n) ? rl(n) || n.proxy : dc(n.parent) : null, Cs = (
...
), Zc = (n) => n === "_" || n === "$", Hu = (n, e) => n !== xe && !n.__isScriptSetup && de(n, e), vm = {
  get({ _: n }, e) {
    ...
    e.indexOf("__v") !== 0) && (i !== xe && Zc(e[0]) && de(i, e) ? P(
  ...
  set({ _: n }, e, t) {
    ...
    return Hu(i, e) ? (i[e] = t, !0) : i.__isScriptSetup && de(i, e) ? (P(`Cannot mutate <script setup> binding "${e}" from Options API.`), !1) : r !== xe && de(r, e) ? (r[e] = t, !0) : de(n.props, e) ? (P(`Attempting to mutate prop "${e}". Props are readonly.`), !1) : e[0] === "$" && e.slice(1) in n ? (P(
  ...
  has({
    ...
    let u;
    return !!t[c] || n !== xe && de(n, c) || Hu(e, c) || (u = o[0]) && de(u, c) || de(r, c) || de(Cs, c) || de(i.config.globalProperties, c);
  },
...
function w0() {
  ...
  return (e, t) => {
    n[t] ? P(`${e} property "${t}" is already defined in ${n[t]}.`) : n[t] = e;
  };
}
let hc = !0;
function y0(n) {
  const e = Gc(n), t = n.proxy, r = n.ctx;
  hc = !1, e.beforeCreate && Pl(e.beforeCreate, n, "bc");
  const {
    // state
    data: i,
    computed: o,
  ...
  if (m && T0(m, r, je), c)
    for (const he in c) {
      const K = c[he];
      se(K) ? (Object.defineProperty(r, he, {
        value: K.bind(t),
        configurable: !0,
        enumerable: !0,
        writable: !0
  ...
  if (i) {
    ...
    if (qc(he) && P(
      ...
      n.data = ku(he);
      for (const K in he)
        je("Data", K), Zc(K[0]) || Object.defineProperty(r, K, {
          configurable: !0,
          enumerable: !0,
          get: () => he[K],
          set: st
  ...
  if (hc = !0, o)
    for (const he in o) {
      const K = o[he], q = se(K) ? K.bind(t, t) : se(K.get) ? K.get.bind(t, t) : st;
      q === st && P(`Computed property "${he}" has no getter.`);
      const Y = !se(K) && se(K.set) ? K.set.bind(t) : () => {
        P(
  ...
  h && Pl(h, n, "c");
  function $e(he, K) {
    ee(K) ? K.forEach((q) => he(q.bind(t))) : K && he(K.bind(t));
  }
  if ($e(s0, g), $e(Fu, y), $e(o0, b), $e(a0, O), $e(n0, A), $e(r0, M), $e(m0, te), $e(f0, R), $e(l0, Q), $e(u0, me), $e(Sm, re), $e(c0, ae), ee(Be))
    if (Be.length) {
      ...
      n.exposed || (n.exposed = {});
  F && n.render === st && (n.render = F), Oe != null && (n.inheritAttrs = Oe), Le && (n.components = Le), Ze && (n.directives = Ze);
}
function T0(n, e, t = st) {
  ee(n) && (n = pc(n));
  for (const r in n) {
    const i = n[r];
    let o;
    ...
    ) : o = vt(i.from || r) : o = vt(i), _e(o) ? Object.defineProperty(e, r, {
      enumerable: !0,
      configurable: !0,
      get: () => o.value,
      set: (c) => o.value = c
...
function Jm(n, e, t, r) {
  const i = r.includes(".") ? km(t, r) : () => t[r];
  if (Ue(n)) {
    const o = e[n];
    se(o) ? Vu(i, o) : P(`Invalid watch handler specified by key "${n}"`, o);
  } else if (se(n))
    Vu(i, n.bind(t));
  else if (Ie(n))
    if (ee(n))
      ...
      se(o) ? Vu(i, o, n) : P(`Invalid watch handler specified by key "${n.handler}"`, o);
    }
  else
    P(`Invalid watch option: "${r}"`, n);
}
function Gc(n) {
...
function B0(n, e) {
  return function(r, i = null) {
    se(r) || (r = Se({}, r)), i != null && !Ie(i) && (P("root props passed to app.mount() must be an object."), i = null);
    const o = Fm();
    ...
    const f = o.app = {
      ...
      use(m, ...h) {
        return c.has(m) ? P("Plugin has already been applied to target app.") : m && se(m.install) ? (c.add(m), m.install(f, ...h)) : se(m) ? (c.add(m), m(f, ...h)) : P(
          'A plugin must either be a function or an object with an "install" function.'
        ), f;
      },
      mixin(m) {
        return o.mixins.includes(m) ? P(
          "Mixin has already been applied to target app" + (m.name ? `: ${m.name}` : "")
        ) : o.mixins.push(m), f;
      },
      component(m, h) {
        return Ec(m, o.config), h ? (o.components[m] && P(`Component "${m}" has already been registered in target app.`), o.components[m] = h, f) : o.components[m];
      },
      directive(m, h) {
        return Im(m), h ? (o.directives[m] && P(`Directive "${m}" has already been registered in target app.`), o.directives[m] = h, f) : o.directives[m];
      },
      mount(m, h, g) {
        if (u)
          P(
          ...
          return y.appContext = o, o.reload = () => {
            n(Bs(y), m, g);
          }, h && e ? e(y, m) : n(y, m, g), u = !0, f._container = m, m.__vue_app__ = f, f._instance = y.component, Pg(f, Xl), rl(y.component) || y.component.proxy;
        }
      },
      unmount() {
        u ? (n(null, f._container), f._instance = null, Kg(f), delete f._container.__vue_app__) : P("Cannot unmount an app that is not mounted.");
      },
      provide(m, h) {
        return m in o.provides && P(
...
function vt(n, e, t = !1) {
  ...
  if (r || mu) {
    ...
    P(`injection "${String(n)}" not found.`);
  } else
    P("inject() can only be used inside setup() or functional components.");
}
function I0(n, e, t, r = !1) {
  const i = {}, o = {};
  ou(o, Au, 1), n.propsDefaults = /* @__PURE__ */ Object.create(null), Am(n, e, i, o);
  for (const c in n.propsOptions[0])
    c in i || (i[c] = void 0);
  Lm(e || {}, i, n), t ? n.props = r ? i : Tg(i) : n.type.props ? n.props = i : n.props = o, n.attrs = o;
}
function O0(n) {
  for (; n; ) {
    if (n.type.__hmrId)
...
function S0(n, e, t, r) {
  ...
  if (
    ...
    for (const g in u)
      ...
      ((h = Ns(g)) === g || !de(e, h))) && (f ? t && // for camelCase
...
function Am(n, e, t, r) {
  ...
  if (e)
    for (let f in e) {
      ...
      const m = e[f];
      let h;
      i && de(i, h = eo(f)) ? !o || !o.includes(h) ? t[h] = m : (u || (u = {}))[h] = m : vu(n.emitsOptions, f) || (!(f in r) || m !== r[f]) && (r[f] = m, c = !0);
    }
  if (o) {
    const f = ce(t), m = u || xe;
  ...
  if (c != null) {
    ...
    if (u && r === void 0) {
      ...
      if (c.type !== Function && !c.skipFactory && se(f)) {
        ...
        t in m ? r = m[t] : (to(i), r = m[t] = f.call(
          null,
          e
        ), qs());
      } else
...
function Um(n, e, t = !1) {
  ...
  if (!o && !f)
    return Ie(n) && r.set(n, Rs), Rs;
  if (ee(o))
    for (let h = 0; h < o.length; h++) {
      Ue(o[h]) || P("props must be strings when using array syntax.", o[h]);
      const g = eo(o[h]);
      $l(g) && (c[g] = xe);
    }
  else if (o) {
    Ie(o) || P("invalid props options", o);
    for (const h in o) {
      const g = eo(h);
      if ($l(g)) {
        const y = o[h], b = c[g] = ee(y) || se(y) ? { type: y } : Se({}, y);
        if (b) {
          const O = Vl(Boolean, b.type), A = Vl(String, b.type);
          b[
            0
            /* shouldCast */
          ] = O > -1, b[
            1
            /* shouldCastTrue */
          ] = A < 0 || O < A, (O > -1 || de(b, "default")) && u.push(g);
        }
      }
    }
  }
  const m = [c, u];
  return Ie(n) && r.set(n, m), m;
}
function $l(n) {
  return n[0] !== "$" ? !0 : (P(`Invalid prop name: "${n}" is a reserved property.`), !1);
}
function wc(n) {
...
function Vl(n, e) {
  return ee(e) ? e.findIndex((t) => Ml(t, n)) : se(e) && Ml(e, n) ? 0 : -1;
}
function Lm(n, e, t) {
  ...
  if (!(e == null && !o)) {
    if (i != null && i !== !0 && !u) {
      ...
      for (let g = 0; g < m.length && !f; g++) {
        const { valid: y, expectedType: b } = F0(e, m[g]);
        h.push(b || ""), f = y;
      }
      if (!f) {
        P(A0(n, e, h));
    ...
    c && !c(e) && P('Invalid prop: custom validator check failed for prop "' + n + '".');
  }
}
const J0 = /* @__PURE__ */ ks(
...
function F0(n, e) {
  ...
  if (J0(r)) {
    ...
    r === "Object" ? t = Ie(n) : r === "Array" ? t = ee(n) : r === "null" ? t = n === null : t = n instanceof e;
  return {
    valid: t,
    expectedType: r
  };
...
function A0(n, e, t) {
  ...
  const i = t[0], o = Pc(e), c = Hl(e, i), u = Hl(e, o);
  return t.length === 1 && jl(i) && !U0(i, o) && (r += ` with value ${c}`), r += `, got ${o} `, jl(o) && (r += `with value ${u}.`), r;
}
function Hl(n, e) {
...
const Dm = (n) => n[0] === "_" || n === "$stable", Qc = (n) => ee(n) ? n.map(Et) : [Et(n)], L0 = (n, e, t) => {
  if (e._n)
    return e;
  const r = Wg((...i) => (He && P(
  ...
  if (r.shapeFlag & 32) {
    const u = e._;
    u ? Ts ? (Se(i, e), on(n, "set", "$slots")) : t && u === 1 ? o = !1 : (Se(i, e), !t && u === 1 && delete i._) : (o = !e.$stable, Cm(e, i)), c = e;
  } else
    e && (qm(n, e), c = { default: 1 });
  if (o)
    for (const u in i)
      !Dm(u) && !(u in c) && delete i[u];
};
function yc(n, e, t, r, i = !1) {
  ...
  if (m != null && m !== f && (Ue(m) ? (h[m] = null, de(g, m) && (g[m] = null)) : _e(m) && (m.value = null)), se(f))
    is(f, u, 12, [c, h]);
  else {
    const y = Ue(f), b = _e(f);
    if (y || b) {
      const O = () => {
        if (n.f) {
          ...
          y ? (h[f] = c, de(g, f) && (g[f] = c)) : b ? (f.value = c, n.k && (h[n.k] = c)) : P("Invalid template ref type:", f, `(${typeof f})`);
      };
      c ? (O.id = -1, Ge(O, t)) : O();
    } else
      P("Invalid template ref type:", f, `(${typeof f})`);
  }
}
let ao, gs;
function un(n, e) {
  n.appContext.config.performance && du() && gs.mark(`vue-${e}-${n.uid}`), Vg(n, e, du() ? gs.now() : Date.now());
}
function cn(n, e) {
  if (n.appContext.config.performance && du()) {
    const t = `vue-${e}-${n.uid}`, r = t + ":end";
    gs.mark(r), gs.measure(
      `<${Uu(n, n.type)}> ${e}`,
      t,
      r
    ), gs.clearMarks(t), gs.clearMarks(r);
  }
  Hg(n, e, du() ? gs.now() : Date.now());
}
function du() {
  return ao !== void 0 || (typeof window < "u" && window.performance ? (ao = !0, gs = window.performance) : ao = !1), ao;
}
function q0() {
  const n = [];
  if (n.length) {
...
function K0(n, e) {
  q0();
  const t = au();
  t.__VUE__ = !0, ym(t.__VUE_DEVTOOLS_GLOBAL_HOOK__, t);
  const {
    insert: r,
    remove: i,
    patchProp: o,
  ...
  } = n, A = (w, E, B, J = null, S = null, D = null, $ = !1, U = null, C = Ts ? !1 : !!E.dynamicChildren) => {
    if (w === E)
      return;
    w && !uo(w, E) && (J = Ne(w), ue(w, S, D, !0), w = null), E.patchFlag === -2 && (C = !1, E.dynamicChildren = null);
    const { type: I, ref: j, shapeFlag: V } = E;
    switch (I) {
      case La:
        M(w, E, B, J);
        break;
      ...
      default:
        V & 1 ? R(
          ...
          C,
          De
        ) : P("Invalid VNode type:", I, `(${typeof I})`);
    }
    j != null && S && yc(j, w && w.ref, D, E || w, !E);
  }, M = (w, E, B, J) => {
    if (w == null)
      r(
        E.el = u(E.children),
      ...
      const S = E.el = w.el;
      E.children !== w.children && m(S, E.children);
    }
  }, W = (w, E, B, J) => {
    w == null ? r(
      E.el = f(E.children || ""),
    ...
    if (C = w.el = c(
      ...
      $,
      U
    ), d && Os(w, null, J, "created"), te(C, w, w.scopeId, $, J), V) {
      for (const l in V)
        l !== "value" && !Xa(l) && o(
          C,
          l,
      ...
      "value" in V && o(C, "value", null, V.value), (I = V.onVnodeBeforeMount) && At(I, J, w);
    }
    ...
    const a = (!S || S && !S.pendingBranch) && Z && !Z.persisted;
    a && Z.beforeEnter(C), r(C, E, B), ((I = V && V.onVnodeMounted) || a || d) && Ge(() => {
      I && At(I, J, w), a && Z.enter(C), d && Os(w, null, J, "mounted");
    }, S);
  }, te = (w, E, B, J, S) => {
    if (B && b(w, B), J)
    ...
    if (S) {
      let D = S.subTree;
      if (D.patchFlag > 0 && D.patchFlag & 2048 && (D = xm(D.children) || D), E === D) {
        const $ = S.vnode;
        te(
          w,
          $,
  ...
  }, ae = (w, E, B, J, S, D, $, U, C = 0) => {
    for (let I = C; I < w.length; I++) {
      const j = w[I] = U ? ps(w[I]) : Et(w[I]);
      A(
        null,
        j,
        E,
    ...
    const U = E.el = w.el;
    let { patchFlag: C, dynamicChildren: I, dirs: j } = E;
    C |= w.patchFlag & 16;
    const V = w.props || xe, H = E.props || xe;
    let Z;
    B && Ss(B, !1), (Z = H.onVnodeBeforeUpdate) && At(Z, B, E, w), j && Os(E, w, B, "beforeUpdate"), B && Ss(B, !0), Ts && (C = 0, $ = !1, I = null);
    const d = S && E.type !== "foreignObject";
    if (I ? (Oe(
      w.dynamicChildren,
      I,
      U,
      ...
      else if (C & 2 && V.class !== H.class && o(U, "class", null, H.class, S), C & 4 && o(U, "style", V.style, H.style, S), C & 8) {
    ...
    ((Z = H.onVnodeUpdated) || j) && Ge(() => {
      Z && At(Z, B, E, w), j && Os(E, w, B, "updated");
    }, J);
  }, Oe = (w, E, B, J, S, D, $) => {
    for (let U = 0; U < E.length; U++) {
      const C = w[U], I = E[U], j = (
        ...
        (C.type === Tt || // - In the case of different nodes, there is going to be a replacement
        // which also requires the correct parent container
        !uo(C, I) || // - In the case of a component, it could contain anything.
    ...
    const I = E.el = w ? w.el : u(""), j = E.anchor = w ? w.anchor : u("");
    let { patchFlag: V, dynamicChildren: H, slotScopeIds: Z } = E;
    // #5523 dev root fragment may inherit directives
    (Ts || V & 2048) && (V = 0, C = !1, H = null), Z && (U = U ? U.concat(Z) : Z), w == null ? (r(I, B, J), r(j, B, J), ae(
      E.children,
      B,
      j,
      S,
    ...
    E.slotScopeIds = U, w == null ? E.shapeFlag & 512 ? S.ctx.activate(
      E,
      B,
      J,
      $,
    ...
    const U = w.component = ew(
      w,
      J,
      S
    );
    if (U.type.__hmrId && Lg(U), Za(w), un(U, "mount"), Xc(w) && (U.ctx.renderer = De), un(U, "init"), nw(U), cn(U, "init"), U.asyncDep) {
      if (S && S.registerDep(U, he), !w.el) {
        const C = U.subTree = rn(ct);
        W(null, C, E, B);
      }
      return;
    }
    ...
    const U = () => {
      if (w.isMounted) {
        ...
        Za(j || w.vnode), Ss(w, !1), j ? (j.el = d.el, K(w, j, $)) : j = d, V && oo(V), (l = j.props && j.props.onVnodeBeforeUpdate) && At(l, Z, j, d), Ss(w, !0), un(w, "render");
        const p = Mu(w);
        cn(w, "render");
        const T = w.subTree;
        w.subTree = p, un(w, "patch"), A(
          T,
          p,
          ...
          S,
          D
        ), cn(w, "patch"), j.el = p.el, a === null && Gg(w, p.el), H && Ge(H, S), (l = j.props && j.props.onVnodeUpdated) && Ge(
          () => At(l, Z, j, d),
          S
        ), Tm(w), Ga();
      } else {
        ...
        if (Ss(w, !1), Z && oo(Z), !l && (j = H && H.onVnodeBeforeMount) && At(j, a, E), Ss(w, !0), V && Re) {
          const p = () => {
            un(w, "render"), w.subTree = Mu(w), cn(w, "render"), un(w, "hydrate"), Re(
              V,
              w.subTree,
              w,
              S,
          ...
          cn(w, "render"), un(w, "patch"), A(
            ...
            S,
            D
          ), cn(w, "patch"), E.el = p.el;
        }
        if (d && Ge(d, S), !l && (j = H && H.onVnodeMounted)) {
          const p = E;
          Ge(
            () => At(j, a, p),
            S
        ...
        (E.shapeFlag & 256 || a && Qa(a.vnode) && a.vnode.shapeFlag & 256) && w.a && Ge(w.a, S), w.isMounted = !0, _g(w), E = B = J = null;
      }
    }, C = w.effect = new Mc(
      U,
      () => Su(I),
    ...
    I.id = w.uid, Ss(w, !0), C.onTrack = w.rtc ? (j) => oo(w.rtc, j) : void 0, C.onTrigger = w.rtg ? (j) => oo(w.rtg, j) : void 0, I.ownerInstance = w, I();
  }, K = (w, E, B) => {
    E.component = w;
    const J = w.vnode.props;
    w.vnode = E, w.next = null, S0(w, E.props, J, B), C0(w, E.children, B), Ks(), Ul(), _s();
  }, q = (w, E, B, J, S, D, $, U, C = !1) => {
    const I = w && w.children, j = w ? w.shapeFlag : 0, V = E.children, { patchFlag: H, shapeFlag: Z } = E;
    if (H > 0) {
      if (H & 128) {
        z(
          I,
    ...
    Z & 8 ? (j & 16 && pe(I, S, D), V !== I && h(B, V)) : j & 16 ? Z & 16 ? z(
      I,
      V,
      B,
      J,
    ...
    w = w || Rs, E = E || Rs;
    const I = w.length, j = E.length, V = Math.min(I, j);
    let H;
    for (H = 0; H < V; H++) {
      const Z = E[H] = C ? ps(E[H]) : Et(E[H]);
      A(
        w[H],
        Z,
        B,
    ...
    for (; I <= V && I <= H; ) {
      const Z = w[I], d = E[I] = C ? ps(E[I]) : Et(E[I]);
      if (uo(Z, d))
        A(
          Z,
          d,
    ...
    for (; I <= V && I <= H; ) {
      const Z = w[V], d = E[H] = C ? ps(E[H]) : Et(E[H]);
      if (uo(Z, d))
        A(
          Z,
          d,
    ...
    if (I > V) {
      ...
      const Z = I, d = I, a = /* @__PURE__ */ new Map();
      for (I = d; I <= H; I++) {
        const le = E[I] = C ? ps(E[I]) : Et(E[I]);
        le.key != null && (a.has(le.key) && P(
      ...
      for (I = Z; I <= V; I++) {
        ...
        if (le.key != null)
          ...
          for (l = d; l <= H; l++)
            if (ie[l - d] === 0 && uo(le, E[l])) {
              ye = l;
              break;
            }
        ye === void 0 ? ue(le, S, D, !0) : (ie[ye - d] = I + 1, ye >= k ? k = ye : x = !0, A(
          le,
          E[ye],
          B,
          null,
      ...
      const ke = x ? _0(ie) : Rs;
      for (l = ke.length - 1, I = T - 1; I >= 0; I--) {
        const le = d + I, ye = E[le], Te = le + 1 < j ? E[le + 1].el : J;
        ie[I] === 0 ? A(
          null,
          ye,
          B,
          ...
          U,
          C
        ) : x && (l < 0 || I !== ke[l] ? X(ye, B, Te, 2) : l--);
      }
    }
  }, X = (w, E, B, J, S = null) => {
    const { el: D, type: $, transition: U, children: C, shapeFlag: I } = w;
    if (I & 6) {
    ...
    if (J !== 2 && I & 1 && U)
      if (J === 0)
        U.beforeEnter(D), r(D, E, B), Ge(() => U.enter(D), S);
      else {
    ...
    let a;
    if (d && (a = $ && $.onVnodeBeforeUnmount) && At(a, E, w), j & 6)
      we(w.component, B, J);
    else {
      if (j & 128) {
      ...
      (D !== Tt || V > 0 && V & 64) ? pe(
        ...
        !1,
        !0
      ) : (D === Tt && V & 384 || !S && j & 16) && pe(C, E, B), J && ge(w);
    }
    (d && (a = $ && $.onVnodeUnmounted) || Z) && Ge(() => {
      a && At(a, E, w), Z && Os(w, null, E, "unmounted");
    }, B);
  }, ge = (w) => {
    const { type: E, el: B, anchor: J, transition: S } = w;
    if (E === Tt) {
      w.patchFlag > 0 && w.patchFlag & 2048 && S && !S.persisted ? w.children.forEach(($) => {
        $.type === ct ? i($.el) : ge($);
      }) : be(B, J);
      return;
    }
    ...
    if (w.shapeFlag & 1 && S && !S.persisted) {
      const { leave: $, delayLeave: U } = S, C = () => $(B, D);
      U ? U(w.el, D, C) : C();
    } else
      D();
  }, be = (w, E) => {
    ...
    w.type.__hmrId && Dg(w);
    const { bum: J, scope: S, update: D, subTree: $, um: U } = w;
    J && oo(J), S.stop(), D && (D.active = !1, ue($, w, E, B)), U && Ge(U, E), Ge(() => {
      w.isUnmounted = !0;
    }, E), E && E.pendingBranch && !E.isUnmounted && w.asyncDep && !w.asyncResolved && w.suspenseId === E.pendingId && (E.deps--, E.deps === 0 && E.resolve()), Mg(w);
  }, pe = (w, E, B, J = !1, S = !1, D = 0) => {
    for (let $ = D; $ < w.length; $++)
      ue(w[$], E, B, J, S);
  }, Ne = (w) => w.shapeFlag & 6 ? Ne(w.component.subTree) : w.shapeFlag & 128 ? w.suspense.next() : y(w.anchor || w.el), ve = (w, E, B) => {
    w == null ? E._vnode && ue(E._vnode, null, null, !0) : A(E._vnode || null, w, E, null, null, null, B), Ul(), pm(), E._vnode = w;
  }, De = {
    p: A,
    um: ue,
    m: X,
...
function Ss({ effect: n, update: e }, t) {
...
function hu(n, e, t = !1) {
  ...
  if (ee(r) && ee(i))
    for (let o = 0; o < r.length; o++) {
      const c = r[o];
      let u = i[o];
      u.shapeFlag & 1 && !u.dynamicChildren && ((u.patchFlag <= 0 || u.patchFlag === 32) && (u = i[o] = ps(i[o]), u.el = c.el), t || hu(c, u)), u.type === La && (u.el = c.el), u.type === ct && !u.el && (u.el = c.el);
    }
}
function _0(n) {
  const e = n.slice(), t = [0];
...
const $0 = (n) => n.__isTeleport, Zs = (n) => n && (n.disabled || n.disabled === ""), zl = (n) => typeof SVGElement < "u" && n instanceof SVGElement, Tc = (n, e) => {
  const t = n && n.to;
  if (Ue(t))
    if (e) {
      const r = e(t);
    ...
    return !t && !Zs(n) && P(`Invalid Teleport target: ${t}`), t;
}, M0 = {
  __isTeleport: !0,
  process(n, e, t, r, i, o, c, u, f, m) {
    const {
      ...
      pc: g,
      pbc: y,
      o: { insert: b, querySelector: O, createText: A, createComment: M }
    } = m, W = Zs(e.props);
    let { shapeFlag: me, children: _, dynamicChildren: re } = e;
    if (Ts && (f = !1, re = null), n == null) {
      const F = e.el = M("teleport start"), R = e.anchor = M("teleport end");
      b(F, t, r), b(R, t, r);
      const Q = e.target = Tc(e.props, O), te = e.targetAnchor = A("");
      Q ? (b(te, Q), c = c || zl(Q)) : W || P("Invalid Teleport target on mount:", Q, `(${typeof Q})`);
      const ae = (Be, Oe) => {
        me & 16 && h(
          _,
          Be,
      ...
      e.el = n.el;
      const F = e.anchor = n.anchor, R = e.target = n.target, Q = e.targetAnchor = n.targetAnchor, te = Zs(n.props), ae = te ? t : R, Be = te ? F : Q;
      if (c = c || zl(R), re ? (y(
        n.dynamicChildren,
        re,
        ae,
...
const Tt = Symbol.for("v-fgt"), La = Symbol.for("v-txt"), ct = Symbol.for("v-cmt"), eu = Symbol.for("v-stc"), Eo = [];
let It = null;
function et(n = !1) {
  Eo.push(It = n ? null : []);
}
function j0() {
  Eo.pop(), It = Eo[Eo.length - 1] || null;
}
let Oa = 1;
function Wl(n) {
  Oa += n;
...
function Km(n) {
  return n.dynamicChildren = Oa > 0 ? It || Rs : null, j0(), Oa > 0 && It && It.push(n), n;
}
...
function uo(n, e) {
  return e.shapeFlag & 6 && Hs.has(e.type) ? (n.shapeFlag &= -257, e.shapeFlag &= -513, !1) : n.type === e.type && n.key === e.key;
}
const z0 = (...n) => W0(
  ...n
), Au = "__vInternal", _m = ({ key: n }) => n ?? null, tu = ({
  ref: n,
  ref_key: e,
  ref_for: t
}) => (typeof n == "number" && (n = "" + n), n != null ? Ue(n) || _e(n) || se(n) ? { i: pt, r: n, k: e, f: !!t } : n : null);
function $m(n, e = null, t = null, r = 0, i = null, o = n === Tt ? 0 : 1, c = !1, u = !1) {
  const f = {
    __v_isVNode: !0,
    __v_skip: !0,
    type: n,
  ...
  return u ? (tl(f, t), o & 128 && n.normalize(f)) : t && (f.shapeFlag |= Ue(t) ? 8 : 16), f.key !== f.key && P("VNode created with invalid key (NaN). VNode type:", f.type), Oa > 0 && // avoid a block node from tracking itself
...
const rn = z0;
function W0(n, e = null, t = null, r = 0, i = null, o = !1) {
  if ((!n || n === d0) && (n || P(`Invalid vnode type when creating vnode: ${n}.`), n = ct), el(n)) {
    const u = Bs(
      n,
      e,
      !0
    ...
    return t && tl(u, t), Oa > 0 && !o && It && (u.shapeFlag & 6 ? It[It.indexOf(n)] = u : It.push(u)), u.patchFlag |= -2, u;
  }
  if (zm(n) && (n = n.__vccOpts), e) {
    e = R0(e);
    let { class: u, style: f } = e;
    u && !Ue(u) && (e.class = _c(u)), Ie(f) && (uc(f) && !ee(f) && (f = Se({}, f)), e.style = Is(f));
  }
  const c = Ue(n) ? 1 : Qg(n) ? 128 : $0(n) ? 64 : Ie(n) ? 4 : se(n) ? 2 : 0;
  return c & 4 && uc(n) && (n = ce(n), P(
...
function Bs(n, e, t = !1) {
  const { props: r, ref: i, patchFlag: o, children: c } = n, u = e ? Z0(r || {}, e) : r;
  return {
    __v_isVNode: !0,
    __v_skip: !0,
    type: n.type,
    ...
    suspense: n.suspense,
    ssContent: n.ssContent && Bs(n.ssContent),
    ssFallback: n.ssFallback && Bs(n.ssFallback),
    el: n.el,
    anchor: n.anchor,
    ctx: n.ctx,
    ce: n.ce
...
function Mm(n) {
  const e = Bs(n);
  return ee(n.children) && (e.children = n.children.map(Mm)), e;
}
function Y0(n = " ", e = 0) {
  return rn(La, null, n, e);
}
function X0(n = "", e = !1) {
  return e ? (et(), js(ct, null, n)) : rn(ct, null, n);
}
function Et(n) {
  return n == null || typeof n == "boolean" ? rn(ct) : ee(n) ? rn(
    Tt,
    null,
    // #3666, avoid reference pollution when reusing vnode
    n.slice()
  ) : typeof n == "object" ? ps(n) : rn(La, null, String(n));
}
function ps(n) {
  return n.el === null && n.patchFlag !== -1 || n.memo ? n : Bs(n);
}
function tl(n, e) {
  let t = 0;
  const { shapeFlag: r } = n;
  if (e == null)
    ...
    se(e) ? (e = { default: e, _ctx: pt }, t = 32) : (e = String(e), r & 64 ? (t = 16, e = [Y0(e)]) : t = 8);
...
function Z0(...n) {
  ...
  for (let t = 0; t < n.length; t++) {
    ...
    for (const i in r)
      if (i === "class")
        e.class !== r.class && (e.class = _c([e.class, r.class]));
      else if (i === "style")
        e.style = Is([e.style, r.style]);
      else if (Aa(i)) {
        const o = e[i], c = r[i];
...
let Q0 = 0;
function ew(n, e, t) {
  const r = n.type, i = (e ? e.appContext : n.appContext) || G0, o = {
    uid: Q0++,
    vnode: n,
    type: r,
    parent: e,
  ...
  return o.ctx = h0(o), o.root = e ? e.root : o, o.emit = zg.bind(null, o), n.ce && n.ce(o), o;
}
let He = null, nl, Vs, Rl = "__VUE_INSTANCE_SETTERS__";
(Vs = au()[Rl]) || (Vs = au()[Rl] = []), Vs.push((n) => He = n), nl = (n) => {
  Vs.length > 1 ? Vs.forEach((e) => e(n)) : Vs[0](n);
};
const to = (n) => {
  nl(n), n.scope.on();
}, qs = () => {
  He && He.scope.off(), nl(null);
}, tw = /* @__PURE__ */ ks("slot,component");
function Ec(n, e) {
  const t = e.isNativeTag || jf;
  (tw(n) || t(n)) && P(
...
function nw(n, e = !1) {
  Sa = e;
  const { props: t, children: r } = n.vnode, i = Vm(n);
  I0(n, t, i, e), D0(n, r);
  const o = i ? rw(n, e) : void 0;
  return Sa = !1, o;
}
function rw(n, e) {
  var t;
  const r = n.type;
  {
    ...
    r.compilerOptions && iw() && P(
      '"compilerOptions" is only supported when using a build of Vue that includes the runtime compiler. Since you are using a runtime-only build, the options should be passed via your build tool config instead.'
    );
  }
  n.accessCache = /* @__PURE__ */ Object.create(null), n.proxy = am(new Proxy(n.ctx, vm)), p0(n);
  const { setup: i } = r;
  if (i) {
    const o = n.setupContext = i.length > 1 ? aw(n) : null;
    to(n), Ks();
    const c = is(
      i,
      n,
...
function Yl(n, e, t) {
  se(e) ? n.type.__ssrInlineRender ? n.ssrRender = e : n.render = e : Ie(e) ? (el(e) && P(
    "setup() should not return VNodes directly - return a render function instead."
  ), n.devtoolsRawSetupState = e, n.setupState = lm(e), g0(n)) : e !== void 0 && P(
  ...
  if (!n.render) {
    if (!e && Nc && !r.render) {
      ...
      if (i) {
        ...
        r.render = Nc(i, m), cn(n, "compile");
      }
    }
    n.render = r.render || st;
  }
  to(n), Ks(), y0(n), _s(), qs(), !r.render && n.render === st && !e && (r.template ? P(
...
function aw(n) {
  return Object.freeze({
    ...
    expose: (t) => {
      if (n.exposed && P("expose() should be called only once per setup()."), t != null) {
        let r = typeof t;
        r === "object" && (ee(t) ? r = "array" : _e(t) && (r = "ref")), r !== "object" && P(
...
function rl(n) {
  if (n.exposed)
    return n.exposeProxy || (n.exposeProxy = new Proxy(lm(am(n.exposed)), {
      ...
      has(e, t) {
        return t in e || t in Cs;
      }
    }));
}
const uw = /(?:^|[-_])(\w)/g, cw = (n) => n.replace(uw, (e) => e.toUpperCase()).replace(/[-_]/g, "");
function jm(n, e = !0) {
...
function Uu(n, e, t = !1) {
  ...
  return r ? cw(r) : t ? "App" : "Anonymous";
}
function zm(n) {
  return se(n) && "__vccOpts" in n;
}
const lw = (n, e) => Bg(n, e, Sa), fw = Symbol.for("v-scx"), mw = () => {
  {
    const n = vt(fw);
    return n || P(
...
function dw() {
  ...
  const n = { style: "color:#3ba776" }, e = { style: "color:#0b1bc9" }, t = { style: "color:#b62e24" }, r = { style: "color:#9d288c" }, i = {
    header(g) {
      return Ie(g) ? g.__isVue ? ["div", n, "VueInstance"] : _e(g) ? [
        "div",
        {},
        ["span", n, h(g)],
        "<",
  ...
  function o(g) {
    ...
    const O = f(g, "inject");
    return O && y.push(c("injected", O)), y.push([
      "div",
      {},
      [
        "span",
  ...
  function u(g, y = !0) {
    return typeof g == "number" ? ["span", e, g] : typeof g == "string" ? ["span", t, JSON.stringify(g)] : typeof g == "boolean" ? ["span", r, g] : Ie(g) ? ["object", { object: y ? ce(g) : g }] : ["span", t, String(g)];
  }
  function f(g, y) {
    const b = g.type;
    if (se(b))
  ...
  function m(g, y, b) {
    const O = g[b];
    if (ee(O) && O.includes(y) || Ie(O) && y in O || g.extends && m(g.extends, y, b) || g.mixins && g.mixins.some((A) => m(A, y, b)))
      return !0;
  }
  function h(g) {
...
const Xl = "3.3.4", hw = "http://www.w3.org/2000/svg", As = typeof document < "u" ? document : null, Zl = As && /* @__PURE__ */ As.createElement("template"), pw = {
  insert: (n, e, t) => {
  ...
  createElement: (n, e, t, r) => {
    const i = e ? As.createElementNS(hw, n) : As.createElement(n, t ? { is: t } : void 0);
    return n === "select" && r && r.multiple != null && i.setAttribute("multiple", r.multiple), i;
  },
  createText: (n) => As.createTextNode(n),
  createComment: (n) => As.createComment(n),
  setText: (n, e) => {
    n.nodeValue = e;
  },
  setElementText: (n, e) => {
  ...
  querySelector: (n) => As.querySelector(n),
  setScopeId(n, e) {
    n.setAttribute(e, "");
  },
  // __UNSAFE__
...
const yw = /[^\\];\s*$/, Gl = /\s*!important$/;
function bc(n, e, t) {
  if (ee(t))
    t.forEach((r) => bc(n, e, r));
  else if (t == null && (t = ""), yw.test(t) && P(
    `Unexpected semicolon at the end of '${e}' style value: '${t}'`
  ), e.startsWith("--"))
    n.setProperty(e, t);
  else {
    const r = Tw(n, e);
    Gl.test(t) ? n.setProperty(
      Ns(r),
      t.replace(Gl, ""),
      "important"
    ) : n[r] = t;
...
function Ew(n, e, t, r, i) {
  if (r && e.startsWith("xlink:"))
    t == null ? n.removeAttributeNS(ef, e.slice(6, e.length)) : n.setAttributeNS(ef, e, t);
  else {
    const o = Mp(e);
    t == null || o && !zf(t) ? n.removeAttribute(e) : n.setAttribute(e, o ? "" : t);
  }
}
function Nw(n, e, t, r, i, o, c) {
  ...
  if (t === "" || t == null) {
    const m = typeof n[e];
    m === "boolean" ? t = zf(t) : t == null && m === "string" ? (t = "", f = !0) : m === "number" && (t = 0, f = !0);
  }
  try {
    n[e] = t;
  } catch (m) {
...
function Bw(n, e, t, r, i = null) {
  ...
  if (r && c)
    ...
    if (r) {
      ...
      c && (xw(n, u, c, f), o[e] = void 0);
  }
}
const tf = /(?:Once|Passive|Capture)$/;
function kw(n) {
  let e;
  if (tf.test(n)) {
    e = {};
  ...
  return [n[2] === ":" ? n.slice(3) : Ns(n.slice(2)), e];
}
let Wu = 0;
const Iw = /* @__PURE__ */ Promise.resolve(), Ow = () => Wu || (Iw.then(() => Wu = 0), Wu = Date.now());
function Sw(n, e) {
  const t = (r) => {
    if (!r._vts)
      r._vts = Date.now();
  ...
  return t.value = n, t.attached = Ow(), t;
}
function vw(n, e) {
  if (ee(e)) {
...
const nf = /^on[a-z]/, Jw = (n, e, t, r, i = !1, o, c, u, f) => {
  e === "class" ? gw(n, r, i) : e === "style" ? ww(n, t, r) : Aa(e) ? su(e) || Bw(n, e, t, r, c) : (e[0] === "." ? (e = e.slice(1), !0) : e[0] === "^" ? (e = e.slice(1), !1) : Fw(n, e, r, i)) ? Nw(
    n,
    e,
    r,
    o,
    ...
    u,
    f
  ) : (e === "true-value" ? n._trueValue = r : e === "false-value" && (n._falseValue = r), Ew(n, e, r, i));
};
function Fw(n, e, t, r) {
  return r ? !!(e === "innerHTML" || e === "textContent" || e in n && nf.test(e) && se(t)) : e === "spellcheck" || e === "draggable" || e === "translate" || e === "form" || e === "list" && n.tagName === "INPUT" || e === "type" && n.tagName === "TEXTAREA" || nf.test(e) && Ue(t) ? !1 : e in n;
}
const Aw = /* @__PURE__ */ Se({ patchProp: Jw }, pw);
let rf;
function Uw() {
  return rf || (rf = P0(Aw));
}
const Wm = (...n) => {
  const e = Uw().createApp(...n);
  Lw(e), Dw(e);
  const { mount: t } = e;
  return e.mount = (r) => {
    const i = Cw(r);
...
function Cw(n) {
  ...
  return window.ShadowRoot && n instanceof window.ShadowRoot && n.mode === "closed" && P(
...
qw();
const Pw = () => new Error("Config not initialized");
let nu;
const Kw = (n) => {
  if (n.codeSdk === void 0)
...
ro.getId = () => Math.random().toString(36).substring(2, 15);
const _w = ["width", "height"], $w = /* @__PURE__ */ no({
  __name: "IntentRequestButton",
  emits: ["resize", "invoke"],
  setup(n, { emit: e }) {
    const t = Da(), r = vt("options"), i = (r == null ? void 0 : r.mode) ?? "payment", o = new ro(), c = `${t.codeSdk()}/${i}-request-button/#/${o.id}/p=${Fa(r)}`;
    console.log("url", c);
    const u = Ot(null), f = Ot(0), m = Ot(0);
    Fu(() => {
  ...
  setup(n, { emit: e }) {
    const t = Da(), r = vt("options"), i = (r == null ? void 0 : r.mode) ?? "payment", o = new ro(), c = `${t.codeSdk()}/${i}-request-modal-desktop/#/${o.id}/p=${Fa(r)}`, u = Ot(null);
    console.log("url", c), o.on("codeScanned", () => {
      e("codeScanned");
    }), o.on("clientRejectedPayment", () => {
      e("clientRejectedPayment");
    }), o.on("clientRejectedLogin", () => {
      e("clientRejectedLogin");
  ...
  setup(n, { emit: e }) {
    const t = Da(), r = vt("options"), i = (r == null ? void 0 : r.mode) ?? "payment", o = new ro(), c = `${t.codeSdk()}/${i}-request-modal-mobile/#/${o.id}/p=${Fa(r)}`, u = Ot(null);
    o.on("codeScanned", () => {
      e("codeScanned");
    }), o.on("clientRejectedPayment", () => {
      e("clientRejectedPayment");
  ...
  setup(n) {
    const e = Da(), t = vt("options"), r = (t == null ? void 0 : t.mode) ?? "payment", i = `${e.codeSdk()}/${r}-request-modal-desktop/#/preload/p=${Fa(t)}`, o = Ot(null);
    function c() {
  ...
  setup(n) {
    const e = Da(), t = vt("options"), r = (t == null ? void 0 : t.mode) ?? "payment", i = `${e.codeSdk()}/${r}-request-modal-mobile/#/preload/p=${Fa(t)}`, o = Ot(null);
    function c() {
      const u = (f) => f + " !important";
      return {
        opacity: u("0"),
...
function sf(n, e, t) {
  ...
  if (r && (!Ru(r) && e && Ru(e) && (r = jw(r, new URL(e).origin)), Ru(r)))
    return t && (r = zw(r, t)), { url: r };
}
const Ww = (n) => new Error(`Network error ${n}`), Rw = (n) => new Error(`Request failed with status code ${n}`);
class Yw {
  /**
  ...
  getSender(e) {
    ...
    return (r) => new Promise(async (i, o) => {
      try {
        ...
        if (c.ok) {
          const u = await c.arrayBuffer(), f = pn.fromBinary(new Uint8Array(u));
          i(f);
        } else
          o(Rw(c.status));
      } catch (c) {
  ...
  async send(e, t, r) {
    const i = this.getServiceName(e), { encode: o, decode: c, send: u } = this.useService(e.methods[t]), f = o(r), m = new hn({
      service: i,
      method: t,
      body: f
...
const Xw = "https://cash.getcode.com/v1";
function of(n = {}) {
  const e = n.endpoint ?? Xw;
  return new Yw(e, n.fetch);
}
async function Zw(n, e) {
  const t = await n.getSendMessageRequestProto();
  return (await e.send(Dd, "sendMessage", t)).result, Gs.OK, {
...
class Gw {
  ...
  async send(e) {
    const t = await e.send(bf, "getStatus", this.toProto());
    let r = pu.Pending;
...
class Qw {
  ...
  async send(e) {
    const t = await e.send(bf, "registerWebhook", this.toProto()), r = ey(t.result);
...
const ty = {
  ...
  create: async (n) => {
    const e = of(n);
    let t;
    n.login ? t = new Np(n) : t = new Lc(n);
    const r = await Zw(t, e);
    if (n.webhook) {
      const o = await new Qw({
        intent: r.id,
        url: n.webhook.url
      }).send(e);
      if (!o.success)
        throw new Error(`Unable to register webhook: ${o.message}`);
    }
    return r;
  },
  /**
  ...
  getStatus: async (n) => {
    const e = of(n);
    return await new Gw(n).send(e);
  }
}, ny = { key: 0 }, ry = { key: 1 }, af = 500, iy = /* @__PURE__ */ no({
  __name: "ButtonFlow",
  setup(n) {
    var me, _, re, F;
    const e = (R) => new Promise((Q) => setTimeout(Q, R)), t = vt("options"), r = vt("emit", async () => !1), i = Ot(null), o = Ot(null), c = Ot(!1), u = hy(), f = ((_ = (me = t == null ? void 0 : t.confirmParams) == null ? void 0 : me.success) == null ? void 0 : _.url) !== void 0, m = ((F = (re = t == null ? void 0 : t.confirmParams) == null ? void 0 : re.cancel) == null ? void 0 : F.url) !== void 0;
    function h() {
      if (t) {
        if (t.mode === "payment")
    ...
    async function y() {
      ...
      t.mode === "payment" ? o.value = new Lc(t).getIntentId() : o.value = new bp(t).getIntentId();
      const Q = {
        INTENT_ID: o.value
        // ...
      }, te = window.location.href;
      if (t.confirmParams = {
        success: sf((ae = t.confirmParams) == null ? void 0 : ae.success, te, Q),
        cancel: sf((Be = t.confirmParams) == null ? void 0 : Be.cancel, te, Q)
      }, await lc(), !i.value)
        throw new Error("Missing channel");
    ...
    async function b() {
      var te, ae;
      c.value = !1, await e(af);
      const R = (ae = (te = t == null ? void 0 : t.confirmParams) == null ? void 0 : te.success) == null ? void 0 : ae.url;
      await r("success", { url: R, options: t, intent: o.value }) || f && (window.location.href = R);
    }
    async function O() {
      var te, ae;
      c.value = !1, await e(af);
      const R = (ae = (te = t == null ? void 0 : t.confirmParams) == null ? void 0 : te.cancel) == null ? void 0 : ae.url;
      await r("cancel", { url: R, options: t, intent: o.value }) || m && (window.location.href = R);
    }
    async function A(R) {
    ...
    return document.addEventListener("visibilitychange", async () => {
      if (document.visibilityState === "visible") {
        if (!o.value)
          return;
        const { status: R } = await ty.getStatus({ intent: o.value });
        R === "confirmed" && b();
      }
    }), (R, Q) => h() ? (et(), Es(Tt, { key: 0 }, [
      rn(ds($w), { onInvoke: y }),
      (et(), js(H0, { to: "body" }, [
        c.value ? (et(), Es("div", ny, [
          ds(u) ? (et(), js(ds(Mw), {
            key: 0,
            onChannelCreated: g,
            onIntentSubmitted: b,
            onClientRejectedPayment: O,
            onClientRejectedLogin: O,
            onError: A,
            onStreamTimeout: M,
            onStreamClosed: W
          })) : (et(), js(ds(Rm), {
          ...
          ds(u) ? (et(), js(ds(Hw), { key: 0 })) : (et(), js(ds(Vw), { key: 1 }))
        ]))
      ]))
    ], 64)) : X0("", !0);
  }
}), sy = (n) => new Error(`Unknown element type: ${n}`), yy = (n) => new Error(`Required parameter: ${n}`), Ty = (n) => new Error(`Invalid parameter: ${n}`), uf = "payment", oy = "en";
class Ym {
  /**
  ...
  constructor(e, t) {
    const r = { ...e };
    r.mode = r.mode ?? uf, r.locale = r.locale ?? oy, this.intent = ku(r), this.listeners = [], this.app = t, this.validate();
  }
  /**
  ...
  mount(e) {
    ...
    const r = async (o, c) => {
      const u = ay(c), f = this.listeners.filter((h) => h.event === o);
...
const ly = {
  ...
  create: (n, e) => {
    switch (n) {
      case "button":
        return { button: new uy(e) };
      case "card":
        return { card: new cy(e) };
      default:
        throw sy(n);
    }
  }
...
function Ey() {
  return my() || /^((?!chrome|android).)*safari/i.test(navigator.userAgent);
}
function dy() {
...
Kw(py);
const Ny = { elements: ly, Keypair: fn, PublicKey: gt };
export {
  dy as Android,
  Ty as ErrInvalidParameter,
  yy as ErrRequiredParameter,
  sy as ErrUnknownElementType,
  Ey as Safari,
  Ny as default,
  ly as elements,
  sf as getURLParam,
  my as iOS,
  Xm as iPhone,
  hy as isMobileDevice,
  Ru as isValidURL,
  jw as makeFQDN,
  zw as replaceURLVariables
};
