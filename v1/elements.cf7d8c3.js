...
}, Vu = () => !1, Ff = /^on[^a-z]/, wo = (t) => Ff.test(t), jo = (t) => t.startsWith("onUpdate:"), Se = Object.assign, lc = (t, e) => {
  const n = t.indexOf(e);
  n > -1 && t.splice(n, 1);
}, Af = Object.prototype.hasOwnProperty, le = (t, e) => Af.call(t, e), Q = Array.isArray, Gi = (t) => ra(t) === "[object Map]", Uf = (t) => ra(t) === "[object Set]", re = (t) => typeof t == "function", Ue = (t) => typeof t == "string", fc = (t) => typeof t == "symbol", Oe = (t) => t !== null && typeof t == "object", dc = (t) => Oe(t) && re(t.then) && re(t.catch), Lf = Object.prototype.toString, ra = (t) => Lf.call(t), mc = (t) => ra(t).slice(8, -1), Cf = (t) => ra(t) === "[object Object]", hc = (t) => Ue(t) && t !== "NaN" && t[0] !== "-" && "" + parseInt(t, 10) === t, Lo = /* @__PURE__ */ Si(
...
let Pc;
const Wo = () => Pc || (Pc = typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : typeof window < "u" ? window : typeof {} < "u" ? {} : {});
function vi(t) {
  if (Q(t)) {
    const e = {};
    for (let n = 0; n < t.length; n++) {
...
function Re(t, e, n) {
  if (bi && Ye) {
    ...
    let i = r.get(n);
    i || r.set(n, i = gc()), zu(i, { effect: Ye, target: t, type: e, key: n });
  }
}
function zu(t, e) {
  let n = !1;
...
function oa(t = !1, e = !1) {
  return function(r, i, s) {
    ...
    return (fc(i) ? Yu.has(i) : td(i)) || (t || Re(r, "get", i), e) ? u : qe(u) ? c && hc(i) ? u : u.value : Oe(u) ? t ? il(u) : ua(u) : u;
  };
}
...
function Xu(t = !1) {
  return function(n, r, i, s) {
    ...
    if (!t && (!zo(i) && !Oi(i) && (c = oe(c), i = oe(i)), !Q(n) && qe(c) && !qe(i)))
      return c.value = i, !0;
    const u = Q(n) && hc(r) ? Number(r) < n.length : le(n, r), f = Reflect.set(n, r, i, s);
    return n === oe(s) && (u ? Es(i, c) && $t(n, "set", r, i, c) : $t(n, "add", r, i)), f;
  };
}
function ld(t, e) {
...
function jc(t, e) {
  ...
  let s = r.call(n, t);
  s ? Qu(n, r, t) : (t = oe(t), s = r.call(n, t));
  const c = i.call(n, t);
...
function Rc(t) {
  ...
  let i = n.call(e, t);
  i ? Qu(e, n, t) : (t = oe(t), i = n.call(e, t));
...
function ko(t, e) {
  return function(r, i) {
    const s = this, c = s.__v_raw, u = oe(c), f = e ? yc : t ? Tc : bs;
    return !t && Re(u, "iterate", Di), c.forEach((m, h) => r.call(i, f(m), f(h), s));
  };
}
function So(t, e, n) {
  return function(...r) {
    const i = this.__v_raw, s = oe(i), c = Gi(s), u = t === "entries" || t === Symbol.iterator && c, f = t === "keys" && c, m = i[t](...r), h = n ? yc : e ? Tc : bs;
    return !e && Re(
      s,
      "iterate",
      f ? Ka : Di
...
const bs = (t) => Oe(t) ? ua(t) : t, Tc = (t) => Oe(t) ? il(t) : t;
function ol(t) {
  bi && Ye && (t = oe(t), zu(t.dep || (t.dep = gc()), {
    target: t,
    type: "get",
    key: "value"
  }));
...
class Sd {
  constructor(e, n) {
    this.__v_isShallow = n, this.dep = void 0, this.__v_isRef = !0, this._rawValue = n ? e : oe(e), this._value = n ? e : bs(e);
  }
  get value() {
  ...
  set value(e) {
    ...
    e = n ? e : oe(e), Es(e, this._rawValue) && (this._rawValue = e, this._value = n ? e : bs(e), al(this, e));
  }
}
function hi(t) {
...
function ul(t, e, n) {
  return Ue(e) ? (e = JSON.stringify(e), n ? e : [`${t}=${e}`]) : typeof e == "number" || typeof e == "boolean" || e == null ? n ? e : [`${t}=${e}`] : qe(e) ? (e = ul(t, oe(e.value), !0), n ? e : [`${t}=Ref<`, e, ">"]) : re(e) ? [`${t}=fn${e.name ? `<${e.name}>` : ""}`] : (e = oe(e), n ? e : [`${t}=`, e]);
}
const Ec = {
...
function Hd(t, e) {
  ...
  for (const i of r) {
    const s = gs(i.type);
    zi.has(s) || (s !== n.initialDef && Yc(s, e), zi.add(s)), i.appContext.propsCache.delete(i.type), i.appContext.emitsCache.delete(i.type), i.appContext.optionsCache.delete(i.type), i.ceReload ? (zi.add(s), i.ceReload(e.styles), zi.delete(s)) : i.parent ? da(i.parent.update) : i.appContext.reload ? i.appContext.reload() : typeof window < "u" ? window.location.reload() : console.warn(
...
function ma(t, e) {
  return !t || !wo(e) ? !1 : (e = e.slice(2).replace(/Once$/, ""), le(t, e[0].toLowerCase() + e.slice(1)) || le(t, Bi(e)) || le(t, e));
}
let ct = null, El = null;
function Yo(t) {
  const e = ct;
...
function xa(t) {
  ...
  let K = $, te;
  if ($.patchFlag > 0 && $.patchFlag & 2048 && ([K, te] = tm($)), R && A !== !1) {
    ...
    if (F.length) {
      ...
      else if (!ja && K.type !== it) {
        const G = Object.keys(f), ee = [], ie = [];
        for (let Be = 0, ke = G.length; Be < ke; Be++) {
          const Le = G[Be];
          wo(Le) ? jo(Le) || ee.push(Le[2].toLowerCase() + Le.slice(3)) : ie.push(Le);
        }
        ie.length && _(
  ...
  return n.dirs && (Xc(K) || _(
    "Runtime directive used on component with non-element root node. The directives will not function as intended."
  ), K = ki(K), K.dirs = K.dirs ? K.dirs.concat(n.dirs) : n.dirs), n.transition && (Xc(K) || _(
...
function Bc(t, e, { immediate: n, deep: r, flush: i, onTrack: s, onTrigger: c } = xe) {
  ...
  const te = () => {
    K.stop(), m && m.scope && lc(m.scope.effects, K);
  };
...
function Bl(t) {
  Df(t) && _("Do not use built-in directive ids as custom directive id: " + t);
}
function Ji(t, e, n, r) {
...
), Oc = (t) => t === "_" || t === "$", Ia = (t, e) => t !== xe && !t.__isScriptSetup && le(t, e), kl = {
  get({ _: t }, e) {
    ...
    e.indexOf("__v") !== 0) && (i !== xe && Oc(e[0]) && le(i, e) ? _(
...
function Im(t) {
  ...
  Wa = !1, e.beforeCreate && Qc(e.beforeCreate, t, "bc");
  const {
    // state
    data: i,
    computed: s,
  ...
  if (i) {
    ...
    if (dc(fe) && _(
      ...
      t.data = ua(fe);
      for (const q in fe)
        He("Data", q), Oc(q[0]) || Object.defineProperty(r, q, {
          configurable: !0,
          enumerable: !0,
          get: () => fe[q],
          set: et
  ...
  if (Pe(dm, g), Pe(pa, y), Pe(mm, b), Pe(hm, S), Pe(um, A), Pe(lm, $), Pe(Tm, ee), Pe(ym, z), Pe(wm, G), Pe(pm, ue), Pe(Ol, te), Pe(gm, ie), Q(Be))
    if (Be.length) {
...
function Fm(t, e) {
  return function(r, i = null) {
    ...
    const f = s.app = {
      ...
      component(m, h) {
        return Qa(m, s.config), h ? (s.components[m] && _(`Component "${m}" has already been registered in target app.`), s.components[m] = h, f) : s.components[m];
      },
      directive(m, h) {
        return Bl(m), h ? (s.directives[m] && _(`Directive "${m}" has already been registered in target app.`), s.directives[m] = h, f) : s.directives[m];
      },
      mount(m, h, g) {
        if (u)
          _(
      ...
      unmount() {
        u ? (t(null, f._container), f._instance = null, Rd(f), delete f._container.__vue_app__) : _("Cannot unmount an app that is not mounted.");
      },
      provide(m, h) {
  ...
  if (Q(s))
    ...
    for (const h in s) {
      ...
      if (nu(g)) {
        ...
        if (b) {
          const S = iu(Boolean, b.type), A = iu(String, b.type);
          b[
            0
            /* shouldCast */
          ] = S > -1, b[
...
function iu(t, e) {
  return Q(e) ? e.findIndex((n) => ru(n, t)) : re(e) && ru(e, t) ? 0 : -1;
}
function Al(t, e, n) {
...
const Ul = (t) => t[0] === "_" || t === "$stable", Sc = (t) => Q(t) ? t.map(pt) : [pt(t)], $m = (t, e, n) => {
  ...
  if (r.shapeFlag & 32) {
    const u = e._;
    u ? Ni ? (Se(i, e), $t(t, "set", "$slots")) : n && u === 1 ? s = !1 : (Se(i, e), !n && u === 1 && delete i._) : (s = !e.$stable, Ll(e, i)), c = e;
  } else
    ...
    if (y || b) {
      const S = () => {
        if (t.f) {
          ...
          i ? Q(A) && lc(A, s) : Q(A) ? A.includes(s) || A.push(s) : y ? (h[f] = [s], le(g, f) && (g[f] = h[f])) : (f.value = [s], t.k && (h[t.k] = f.value));
        } else
...
function Rm(t, e) {
  ...
  const {
    ...
    if (w === E)
      return;
    w && !as(w, E) && (J = Ee(w), se(w, k, L, !0), w = null), E.patchFlag === -2 && (C = !1, E.dynamicChildren = null);
    ...
    if (k) {
      let L = k.subTree;
      if (L.patchFlag > 0 && L.patchFlag & 2048 && (L = bl(L.children) || L), E === L) {
        const P = k.vnode;
        ee(
          w,
          P,
    ...
    for (let U = 0; U < E.length; U++) {
      const C = w[U], O = E[U], H = (
        ...
        !as(C, O) || // - In the case of a component, it could contain anything.
    ...
    const U = w.component = ah(
      w,
      J,
      k
    );
    if (U.type.__hmrId && $d(U), Co(w), Ht(U, "mount"), Ic(w) && (U.ctx.renderer = Ce), Ht(U, "init"), uh(U), jt(U, "init"), U.asyncDep) {
    ...
    const U = () => {
      if (w.isMounted) {
        ...
        Co(H || w.vnode), Fi(w, !1), H ? (H.el = d.el, q(w, H, P)) : H = d, M && ss(M), (l = H.props && H.props.onVnodeBeforeUpdate) && Nt(l, Z, H, d), Fi(w, !0), Ht(w, "render");
        const p = xa(w);
        jt(w, "render");
        const T = w.subTree;
        ...
        if (Fi(w, !1), Z && ss(Z), !l && (H = V && V.onVnodeBeforeMount) && Nt(H, a, E), Fi(w, !0), M && We) {
          const p = () => {
        ...
        (E.shapeFlag & 256 || a && _o(a.vnode) && a.vnode.shapeFlag & 256) && w.a && Ze(w.a, k), w.isMounted = !0, Wd(w), E = B = J = null;
      }
    }, C = w.effect = new wc(
      U,
      () => da(O),
    ...
    O.id = w.uid, Fi(w, !0), C.onTrack = w.rtc ? (H) => ss(w.rtc, H) : void 0, C.onTrigger = w.rtg ? (H) => ss(w.rtg, H) : void 0, O.ownerInstance = w, O();
  }, q = (w, E, B) => {
    E.component = w;
    const J = w.vnode.props;
    w.vnode = E, w.next = null, Cm(w, E.props, J, B), Vm(w, E.children, B), Mi(), zc(), Vi();
    ...
    if (U != null && Za(U, null, B, w, !0), H & 256) {
      E.ctx.deactivate(w);
      return;
    }
    ...
    J && ss(J), k.stop(), L && (L.active = !1, se(P, w, E, B)), U && Ze(U, E), Ze(() => {
      w.isUnmounted = !0;
    ...
    w == null ? E._vnode && se(E._vnode, null, null, !0) : A(E._vnode || null, w, E, null, null, null, B), zc(), ml(), E._vnode = w;
  }, Ce = {
    p: A,
    um: se,
    m: X,
...
const zm = (t) => t.__isTeleport, es = (t) => t && (t.disabled || t.disabled === ""), au = (t) => typeof SVGElement < "u" && t instanceof SVGElement, Ga = (t, e) => {
  const n = t && t.to;
  if (Ue(n))
    if (e) {
      const r = e(n);
  ...
  process(t, e, n, r, i, s, c, u, f, m) {
    ...
    if (Ni && (f = !1, te = null), t == null) {
      ...
      b(F, n, r), b(z, n, r);
      const G = e.target = Ga(e.props, S), ee = e.targetAnchor = A("");
      G ? (b(ee, G), c = c || au(G)) : R || _("Invalid Teleport target on mount:", G, `(${typeof G})`);
      const ie = (Be, ke) => {
        ue & 16 && h(
          K,
          Be,
...
function Kl(t, e = null, n = null, r = 0, i = null, s = t === ht ? 0 : 1, c = !1, u = !1) {
  ...
  return u ? (Jc(f, n), s & 128 && t.normalize(f)) : n && (f.shapeFlag |= Ue(n) ? 8 : 16), f.key !== f.key && _("VNode created with invalid key (NaN). VNode type:", f.type), Bs > 0 && // avoid a block node from tracking itself
...
function eh(t, e = null, n = null, r = 0, i = null, s = !1) {
  if ((!t || t === Em) && (t || _(`Invalid vnode type when creating vnode: ${t}.`), t = it), vc(t)) {
    const u = ki(
      t,
      e,
      !0
  ...
  if (Hl(t) && (t = t.__vccOpts), e) {
    ...
    u && !Ue(u) && (e.class = pc(u)), Oe(f) && ($a(f) && !Q(f) && (f = Se({}, f)), e.style = vi(f));
  }
  const c = Ue(t) ? 1 : om(t) ? 128 : zm(t) ? 64 : Oe(t) ? 4 : re(t) ? 2 : 0;
  return c & 4 && $a(t) && (t = oe(t), _(
...
function th(t) {
  return t ? $a(t) || ga in t ? Se({}, t) : t : null;
}
function ki(t, e, n = !1) {
...
function Jc(t, e) {
  ...
  if (e == null)
    ...
    re(e) ? (e = { default: e, _ctx: ct }, n = 32) : (e = String(e), r & 64 ? (n = 16, e = [nh(e)]) : n = 8);
...
(Hi = Wo()[uu]) || (Hi = Wo()[uu] = []), Hi.push((t) => Me = t), Fc = (t) => {
...
function lu(t, e, n) {
  re(e) ? t.type.__ssrInlineRender ? t.ssrRender = e : t.render = e : Oe(e) ? (vc(e) && _(
    "setup() should not return VNodes directly - return a render function instead."
  ), t.devtoolsRawSetupState = e, t.setupState = cl(e), xm(t)) : e !== void 0 && _(
...
function Ml(t, e, n) {
  ...
  ns(t), Mi(), Im(t), Vi(), Pi(), !r.render && t.render === et && !e && (r.template ? _(
...
function qh(t, e, n, r) {
  return r ? !!(e === "innerHTML" || e === "textContent" || e in t && wu.test(e) && re(n)) : e === "spellcheck" || e === "draggable" || e === "translate" || e === "form" || e === "list" && t.tagName === "INPUT" || e === "type" && t.tagName === "TEXTAREA" || wu.test(e) && Ue(n) ? !1 : e in t;
}
const Kh = /* @__PURE__ */ Se({ patchProp: _h }, Nh);
let yu;
function Ph() {
  return yu || (yu = jm(Kh));
}
...
const Wh = 34028234663852886e22, zh = -34028234663852886e22, Yh = 4294967295, Xh = 2147483647, Zh = -2147483648;
function $o(t) {
  if (typeof t != "number")
...
function Rl(t) {
  ...
  if (Number.isFinite(t) && (t > Wh || t < zh))
    throw new Error("invalid float 32: " + t);
}
const Wl = Symbol("@bufbuild/protobuf/enum-type");
function Gh(t) {
  const e = t[Wl];
      ...
      for (const [u, f] of Object.entries(r)) {
        ...
        if (m.repeated) {
          ...
          for (const [b, S] of Object.entries(f)) {
            ...
            try {
              y[cs(m.K, m.K == v.BOOL ? b == "true" ? !0 : b == "false" ? !1 : b : b).toString()] = A;
            } catch ($) {
...
class rr extends x {
  constructor(e) {
    super(), this.accountType = st.UNKNOWN, this.index = me.zero, this.balanceSource = $s.UNKNOWN, this.balance = me.zero, this.managementState = Ms.UNKNOWN, this.blockchainState = Vs.UNKNOWN, this.mustRotate = !1, this.claimState = Hs.UNKNOWN, o.util.initPartial(e, this);
  }
  static fromBinary(e, n) {
...
class ur extends x {
  constructor(e) {
    super(), this.result = Ws.OK, this.contacts = [], o.util.initPartial(e, this);
  }
  static fromBinary(e, n) {
...
o.util.setEnumType(Ws, "code.contact.v1.GetContactsResponse.Result", [
  { no: 0, name: "OK" }
]);
class lr extends x {
  constructor(e) {
...
class dr extends x {
  constructor(e) {
    super(), this.result = zs.OK, this.rates = {}, o.util.initPartial(e, this);
  }
  static fromBinary(e, n) {
...
o.util.setEnumType(zs, "code.currency.v1.GetAllRatesResponse.Result", [
  { no: 0, name: "OK" },
...
class Wp extends lf {
  ...
  process(e, n) {
    ...
    for (let g = 0; g < 64; g++) {
      const y = xt(u, 6) ^ xt(u, 11) ^ xt(u, 25), b = h + y + Hp(u, f, m) + Rp[g] + li[g] | 0, A = (xt(r, 2) ^ xt(r, 13) ^ xt(r, 22)) + jp(r, i, s) | 0;
...
const ff = /* @__PURE__ */ uf(() => new Wp());
var Ta = {}, Ea = {};
Ea.byteLength = Xp;
Ea.toByteArray = Gp;
Ea.fromByteArray = t0;
var St = [], ot = [], zp = typeof Uint8Array < "u" ? Uint8Array : Array, Ua = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";
...
function Gp(t) {
  var e, n = df(t), r = n[0], i = n[1], s = new zp(Zp(t, r, i)), c = 0, u = i > 0 ? r - 4 : r, f;
  for (f = 0; f < u; f += 4)
...
(function(t) {
  ...
  function We(d, a, l, p, T, N) {
    if (d > l || d < a) {
      ...
      let ne;
      throw N > 3 ? a === 0 || a === BigInt(0) ? ne = `>= 0${I} and < 2${I} ** ${(N + 1) * 8}${I}` : ne = `>= -(2${I} ** ${(N + 1) * 8 - 1}${I}) and < 2 ** ${(N + 1) * 8 - 1}${I}` : ne = `>= ${a}${I} and <= ${l}${I}`, new Ee.ERR_OUT_OF_RANGE("value", ne, d);
    }
    De(p, T, N);
  }
  function w(d, a) {
...
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
const dt = BigInt(0), rt = BigInt(1), Uo = BigInt(2), W0 = BigInt(8), z0 = { zip215: !0 };
function Y0(t) {
  const e = R0(t);
  return Dc(t, {
    hash: "function",
...
function _c(t) {
  const e = Y0(t), { Fp: n, n: r, prehash: i, hash: s, randomBytes: c, nByteLength: u, h: f } = e, m = Uo << BigInt(u * 8) - rt, h = n.create, g = e.uvRatio || ((q, D) => {
    try {
  ...
  class F {
    ...
    assertValidity() {
      ...
      const { ex: j, ey: X, ez: se, et: he } = this, Ne = h(j * j), pe = h(X * X), de = h(se * se), Ee = h(de * de), Je = h(Ne * D), Ce = h(de * h(Je + pe)), De = h(Ee + h(Y * h(Ne * pe)));
      if (Ce !== De)
    ...
    equals(D) {
      te(D);
      const { ex: Y, ey: j, ez: X } = this, { ex: se, ey: he, ez: Ne } = D, pe = h(Y * Ne), de = h(se * X), Ee = h(j * Ne), Je = h(he * X);
      return pe === de && Ee === Je;
    }
    is0() {
    ...
    double() {
      const { a: D } = e, { ex: Y, ey: j, ez: X } = this, se = h(Y * Y), he = h(j * j), Ne = h(Uo * h(X * X)), pe = h(D * se), de = Y + j, Ee = h(h(de * de) - se - he), Je = pe + he, Ce = Je - Ne, De = pe - he, We = h(Ee * Ce), w = h(Je * De), E = h(Ee * De), B = h(Ce * Je);
    ...
    add(D) {
      te(D);
      const { a: Y, d: j } = e, { ex: X, ey: se, ez: he, et: Ne } = this, { ex: pe, ey: de, ez: Ee, et: Je } = D;
      if (Y === BigInt(-1)) {
        const O = h((se - X) * (de + pe)), H = h((se + X) * (de - pe)), M = h(H - O);
        if (M === dt)
          return this.double();
        const V = h(he * Uo * Je), Z = h(Ne * Uo * Ee), d = Z + V, a = H + O, l = Z - V, p = h(d * M), T = h(a * l), N = h(d * l), I = h(M * a);
        return new F(p, T, I, N);
      }
      const Ce = h(X * pe), De = h(se * de), We = h(Ne * j * Je), w = h(he * Ee), E = h((X + se) * (pe + de) - Ce - De), B = w - We, J = w + We, k = h(De - Y * Ce), L = h(E * B), P = h(J * k), U = h(E * k), C = h(B * J);
    ...
    static fromHex(D, Y = !1) {
      ...
      const de = h(pe * pe), Ee = h(de - rt), Je = h(j * de - X);
    ...
    toRawBytes() {
      const { x: D, y: Y } = this.toAffine(), j = ac(Y, n.BYTES);
  ...
  const { BASE: z, ZERO: G } = F, ee = j0(F, u * 8);
  function ie(q) {
    return _e(q, r);
  }
  function Be(q) {
  ...
  function Pe(q, D, Y, j = He) {
    ...
    let pe, de, Ee;
    try {
      pe = F.fromHex(Y, se), de = F.fromHex(q.slice(0, he), se), Ee = z.multiplyUnsafe(Ne);
    } catch {
      return !1;
    }
    ...
    return de.add(pe.multiplyUnsafe(Je)).subtract(Ee).clearCofactor().equals(F.ZERO);
  }
...
const bg = { status: na.Pending }, Ng = { status: na.Confirmed }, xg = {
  ...
  setup(t) {
    var ue, K, te, F;
    const e = (z) => new Promise((G) => setTimeout(G, z)), n = bt("options"), r = bt("emit", async () => !1), i = Tt(null), s = Tt(null), c = Tt(!1), u = Cg(), f = ((K = (ue = n == null ? void 0 : n.confirmParams) == null ? void 0 : ue.success) == null ? void 0 : K.url) !== void 0, m = ((F = (te = n == null ? void 0 : n.confirmParams) == null ? void 0 : te.cancel) == null ? void 0 : F.url) !== void 0;
    function h() {
    ...
    async function y() {
      ...
      if (n.confirmParams = {
        success: Du((ie = n.confirmParams) == null ? void 0 : ie.success, ee, G),
        cancel: Du((Be = n.confirmParams) == null ? void 0 : Be.cancel, ee, G)
      }, await Va(), !i.value)
        throw new Error("Missing channel");
    ...
    return document.addEventListener("visibilitychange", async () => {
      if (document.visibilityState === "visible") {
        if (!s.value)
          return;
        const { status: z } = await xg.getStatus({ intent: s.value });
        z === "confirmed" && b();
      }
